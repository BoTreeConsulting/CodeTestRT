 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Accounts /</span><span>Add New Account</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	
    	    	<div class="headtext1"> <a href="<?php echo base_url();?>admin/manage_venues" style="color:#FFF">Manage Accounts </a>/ <span>Add New Account</span></div>
   ...
   <div class="col-md-6">
    ...
    <input type="file" name="invoices[]" id='input_1' ><img class="add right" src="<?php echo base_url();?>assets/img/add.png" />
...
<div class="form-group" id='quote_1'>
	...
	<input type="file" name="quotations[]" id="quote_1" ><img class="add1 right" src="<?php echo base_url();?>assets/img/add.png" />
</div>
</div>
</div> 
  ...
  <button type="submit" name="add" class="btn btn-xs btn-default btyellow" style="height:35px;">Add Accounts</button>
</div>
</form>
		</div>
		<div class="col-md-6">
