 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Staff /</span> <span>Manage Timesheet of Staff</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	
	
    	<div class="headtext1"><span> Manage Timesheet of Staff</span></div>
...
<?php } ?>
    ...
    <div class="tablewidth" >
		...
		<input type="text" style="height:30px; margin: 10px;">
		<button type="submit" class="btn btn-xs btn-default btyellow" style="height:35px;">Search</button>
	   </div>-->
		 ...
		 <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				?>
						...
						<td data-title="Assign Timesheet"><a href="<?php echo base_url();?>admin/assign_timesheet/<?php echo $row['admin_id'];?>">Assign/View</a></td>
