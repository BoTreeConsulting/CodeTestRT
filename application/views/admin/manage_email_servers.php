...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Realtytopia Manage Email Server</title>
 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Manage Email Servers </span><!--<span>Manage Email Servers</span>--></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);
	//print_r($_SESSION);?>
    	<div class="headtext1"><span> Manage Email Servers</span></div>
...
<?php } ?>
		...
		<div class="mtext">
            	<div style=" margin-bottom:17px;">
                    <a href="<?php echo base_url();?>admin/add_mail_server" class="btn btn-xs btn-default btyellow pull-left">Add New</a>
                    <div class="clear"></div>
                </div>
            </div>
        <div>
    <div class="tablewidth" >
		...
		<form method="post" action="<?php echo base_url();?>admin/changeemailserverstatus">
		  ...
		  <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				foreach($emailserver as $row){
				
				?>
						<tr>
						
						<td data-title="MailServerName"><?php echo $row['mail_server_name'];?></td>
						
						<td data-title="ActiveOnSite" >
						
						<?php
						if($row['active_on_site']=='1')
						{
							echo "Active";
						}
						else if($row['active_on_site']=='0')
						{
							echo "In Active";
						}
						?>
						...
						<td data-title="Actions" ><a href="<?php echo base_url();?>admin/view_emailserver/<?php echo $row['id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;<a href="<?php echo base_url();?>admin/edit_emailserver/<?php echo $row['id'];?>" title="Edit"><i class="icon-edit"></i></a>&nbsp;<a title="Delete" href="<?php echo base_url();?>admin/delete_emailserver/<?php echo $row['id'];?>" onclick="return confirm_delete('you want to delete this email server')" ><i class="icon-trash"></i></a></td>
