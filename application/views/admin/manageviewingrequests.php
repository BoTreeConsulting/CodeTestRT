...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Realtytopia Manage Viewing Requests</title>
 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	//print_r($_SESSION);?>
    	<div class="headtext1"><span>Manage Viewing Requests</span></div>
...
<?php } ?>
    ...
    <div class="tablewidth" >
		...
		<form method="post" action="<?php echo base_url();?>admin/changeviewingrequeststatus">
	...
	<?php echo date('Y-m-d', strtotime($row['created_on']));?>
						...
						<a href="<?php echo base_url();?>admin/view_viewing_requests/<?php echo $row['id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;
						
						<!--<a href="<?php echo base_url();?>admin/edit_agent/<?php echo $row['id'];?>" title="Edit"><i class="icon-edit"></i></a>&nbsp;
						-->
						<a title="Delete" href="<?php echo base_url();?>admin/delete_viewing_request/<?php echo $row['id'];?>" onclick="return confirm_delete('you want to delete this viewing request')" ><i class="icon-trash"></i></a></td>
