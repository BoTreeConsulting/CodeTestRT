...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Guardian Property Service Normal QIR</title>
...
function myFunction() {
 ...
 //document.getElementById("swidth").style.width = '20% !important';
 document.getElementById("fwidth").style.width = '100%';
 ...
 <?php 
  ...
  <body>
   ...
   <div id="path1" class="col-lg-12 navbar-inner">
	...
	<div id="path2" class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>QIR /</span><span>View Normal QIR</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	<div id="path3" class="headtext1"> <a href="<?php echo base_url();?>admin/manage_qis" style="color:#FFF">Manage QIR </a>/ <span>View Customer</span></div>
    	
        <div class="mtextarea mtextarea2"  id="fwidth">
        
		<div class="row">
		<div class="col-md-12">
		
 
		<h2>For View Normal QIR</h2>
		  ...
		  <table class="table-bordered table-striped table-condensed cf"  style="width:100%;">
			   <thead class="cf" style="background:#044174; color:#fff;">
				...
				?>
					...
					<!--	<td data-title="Attach Image"><div class="attimg"><img src="<?php// echo base_url();?>assets/qis/<?php// echo $pic;?>" width="25px;" height="20px">
						</div></td> -->
						
						<td id="swidth"><a class="example-image-link" href="<?php echo base_url();?>assets/qis/<?php echo $pic;?>" data-lightbox="example-1"><?php if($pic){ ?><img src="<?php echo base_url();?>assets/qis/<?php echo $pic;?>" width="20px;" height="55px"><?php } ?></a></td>
...
<?php echo $normqis[0]['qis_client_rating'];?>
  ...
  <div class="form-group">
    <label for="exampleInputPassword1">Modified on</label> : <?php echo $normqis[0]['qis_modifiedon'];?>
  </div> <?php */ ?>
