 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Skills assessment and training /</span> <span>Add Skills</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	
    	<div class="headtext1"><a href="<?php echo base_url();?>admin/manage_stockitems" style="color:#FFF"> Skills assessment and training</a>/<span>Add Skills</span></div>
  ...
  <div class="form-group" style="margin-bottom: 0px;">
    <div class="row">
              <div class="form-group">
                ...
                <input type="text" name="trainee" id="trainee" class="form-control" >
              </div>
  ...
  <div class="form-group" style="margin-bottom: 0px;">
    <div class="row">
		...
		<!--	<input type="text" name="traineesign" id="traineesign" class="form-control" > -->
			<!--signature starts here -->
   <div class='sigPad' >
   ...
   <!--signature ends here -->
		  ...
		  <div class="form-group">
		  <label class="control-label">Signature:</label>
	<!--	  <input type="text" class="form-control"  name="trainersign" id="trainersign"> -->
		  <!--signature starts here -->
   <div class='sigPad1' >
				<div style="border-style: solid;
    border-width: 1px; border-color:#C4C4C4; width:500px;"><canvas class='pad' width='495' height='70'name='sign' id='sign'></canvas> </div>
			  ...
			  <thead class="cf" style="background:#044174; color:#fff;">
				...
				<tbody>
					...
					<tr>
						...
						<td data-title="Skills Assessed"><input type="text" name='assenble[]' class="ff1"></td>
						<td data-title="Training Required" ><input type="text" name='trainingreq[]' class="ff1"></td>
						<td data-title="Training Completed" ><input type="text" name='cmplt1[]' class="ff1"></td>
						<td data-title="Training Completed" ><input type="text" name='cmplt2[]' class="ff1"></td>
						<td data-title="Training Completed" ><input type="text" name='cmplt3[]' class="ff1"></td>
						<td data-title="Site Induction/ QA Aware" ><input type="text" name='induction[]' class="ff1"></td>
					</tr>
					<?php } ?>
  ...
  <div><button type="submit" name="add" value="add" class="btn btn-lg btyellow btlarge pull-right">Add Skills</button></div>
</form></div>
		</div>
		<div class="col-md-6">
