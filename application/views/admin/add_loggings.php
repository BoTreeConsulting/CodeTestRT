 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Logging /</span> <span>Add Loggings</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	
    	<div class="headtext1"><a href="<?php echo base_url();?>admin/manage_commencement" style="color:#FFF"> Logging </a>/<span>Add Loggings</span></div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" placeholder="" name="dateandtime" id="datetimepicker_mask" >
  </div>
  <div class="form-group">
  ...
  <div class="form-group" style="margin-bottom: 0px;">
    <div class="row">
              <div class="col-md-6 form-group expiration required">
                ...
                <input type="text" class="form-control" placeholder="" name="longitude" id="us3-lon">
              </div>
              <div class="col-md-6 form-group expiration required">
                <label class="control-label">Latitude</label>
                <input type="text" class="form-control" placeholder="" name="latitude" id="us3-lat">
              </div>
            </div>
  </div>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" rows="3" cols="3" name="address" id="us3-address" ></textarea>
  </div>
    ...
    <script>$('#us3').locationpicker({
        location: {latitude: 51.384814, longitude: -2.362463},
        radius: 300,
        inputBinding: {
  ...
  <button type="submit" class="btn btn-primary btn-outline btn-lg" name="add" value="logging" id="">Add Logging</button>
</form></div>
		</div>
		<div class="col-md-6">
