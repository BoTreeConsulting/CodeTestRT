 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	//print_r($_SESSION);?>
    	<div class="headtext1"><span>Manage Agent Inquiries</span></div>
...
<?php } ?>
    ...
    <div class="tablewidth" >
		...
		<form method="post" action="<?php echo base_url();?>admin/changeagentinquirystatus">
		  ...
		  <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				?>
						...
						<a href="<?php echo base_url();?>admin/view_agents_inquiries/<?php echo $row['id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;
						
						<a title="Delete" href="<?php echo base_url();?>admin/delete_agents_inquiries/<?php echo $row['id'];?>" onclick="return confirm_delete('you want to delete this inquiry')" ><i class="icon-trash"></i></a></td>
