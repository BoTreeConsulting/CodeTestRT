 ...
 //print_r($_SESSION);
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Accounts /</span> <span>Manage Accounts</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	
	
    	<div class="headtext1"><span> Manage Accounts</span></div>
...
<?php } ?>
		...
		<div class="mtext">
            	<div style=" margin-bottom:17px;">
                    <a href="<?php echo base_url();?>admin/add_account" class="btn btn-xs btn-default btyellow pull-left">Add New Account</a>
                    <div class="clear"></div>
                </div>
				<form method='post'>
...
$i=0;
						...
						<td data-title="Customer Name"><?php echo $account_info[$i]->ac_name; ?></td>
						<td data-title="Created By" ><?php echo $account_info[$i]->cby; ?></td>
						<td data-title="Created On"><?php echo date("M d Y h:i A",strtotime($account_info[$i]->createdon)); ?></td>
						<td data-title="Modified By"><?php echo $account_info[$i]->mby; ?></td>
						<td data-title="Modified On" ><?php echo date("M d Y h:i A",strtotime($account_info[$i]->createdon)); ?></td>
						<td data-title="Actions" ><a href="<?php echo base_url();?>admin/view_account/<?php echo $account_info[$i]->aid;?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;<a href="<?php echo base_url();?>admin/edit_account/<?php echo $account_info[$i]->aid; ?> " title="Edit"><i class="icon-edit"></i></a>&nbsp;<a title="Delete" href="<?php echo base_url();?>admin/delete_account/<?php echo $account_info[$i]->aid;?>"><i class="icon-trash" onclick="return confirm_delete()"></i></a></td>
						<td data-title="Check" ><input type="checkbox" name='status[]' value="<?php echo $account_info[$i]->aid;?>" ></td>
