 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Commencement Checklist /</span> <span>Add Commencement Checklist</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	
    	<div class="headtext1"><a href="<?php echo base_url();?>admin/manage_commencement" style="color:#FFF"> Manage Commencement Checklist </a>/<span>Add Commencement Checklist</span></div>
  ...
  <div class="form-group" style="margin-bottom: 0px;">
    <div class="row">
              <div class="col-xs-6 form-group expiration required">
                ...
                <input type="text" class="form-control" name="submitdate" id="datepicker">
              </div>
              <div class="col-xs-6 form-group expiration required">
  ...
  <div class="form-group">
    <label for="exampleInputEmail1">Address of Contract <span class="required_field"> * </span></label>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="opcontact" id="opcontact" >
  </div>
  <div class="form-group" style="margin-bottom: 0px;">
    <div class="row">
              ...
              <div class="col-xs-4 form-group expiration required">
                ...
                <input type="text" class="form-control" name="fax" id="exampleFaxNo">
              </div>
            </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group" style="margin-bottom: 0px;">
    <div class="row">
              <div class="col-xs-6 form-group expiration required">
                ...
                <input type="text" class="form-control" name="comensdate"  id="datepicker1">
              </div>
              <div class="col-xs-6 form-group expiration required">
  ...
  <div class="form-group">
	...
	<td data-title="Days Per Week of Service"><input type="text" class="form-control" name="daysperweek" id="margin"></td>
						

						
					
						<td data-title="Days Per Week of Service"><input type="text" class="form-control" name="weeklytoatl" id="margin"></td>
						

						<td data-title="Days Per Week of Service"><input type="text" class="form-control" name="monthlytotal" id="margin"></td>
  ...
  <div class="form-group">
    ...
    <div><input type="radio" value="Yes" name="fm">Yes &nbsp;&nbsp;<span><input type="radio" value="No" name="fm">No </span></div>
	<hr>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div><input type="radio" value="Yes" name="facilitycontract">Yes &nbsp;&nbsp;<span><input type="radio" value="No" name="facilitycontract">No </span></div>
	<hr>
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Is the full area to be cleaned from commencement date</label>
    <div><input type="radio" value="Yes" name="clean">Yes &nbsp;&nbsp;<span><input type="radio" value="No" name="clean">No </span></div>
	<hr>
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">If No please nominate any vacant areas</label>
    <input type="text" class="form-control" name="nominate" id="nominate" >
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Sub Contractor <span class="required_field"> * </span></label>
    <input type="text" class="form-control" name="subcontractor" id="subcontractor" >
  </div>
  <div class="form-group" style="margin-bottom: 0px;">
    <div class="row">
              <div class="col-xs-6 form-group expiration required">
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" rows="3" name="comments" id="comments" cols="3"></textarea>
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">New Client Letter sent</label>
    <div><input type="radio" value="Yes" name="letter">Yes &nbsp;&nbsp;<span><input type="radio" value="No" name="letter">No </span></div>
	<hr>
  </div>
  <div class="form-group" style="margin-bottom: 0px;">
    <div class="row">
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" rows="3" name="client" id="client" cols="3"></textarea>
  </div>
  <div class="form-group">
...
<div class="form-group">
  ...
  <button type="submit" name="add" class="btn btn-primary btn-outline btn-lg">Submit</button>
</form></div>
		</div>
		<div class="col-md-6">
		</div>
