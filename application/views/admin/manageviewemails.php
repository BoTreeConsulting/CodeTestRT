...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Realtytopia Manage View Emails</title>
        ...
        <script>       
            ...
            function manage_emails_search(user){
               $('#usersearch').submit();
            }
        </script>
    ...
    <body>   
        ...
        <div class="col-md-12 remove-padd">
            ...
            <div class="col-md-10 rtcol">
                ...
                <div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Manage Members  / </span><span>View Emails</span></div>
                <?php
                   $total = $this->uri->total_segments();
                   $modulename = $this->uri->segment($total);
                ?>
                <div class="headtext1"><span> View Emails</span></div>
                    ...
                    <div class="mtext">
                        <div style="margin-bottom:17px;">                           
                            <div style="float:right;">
                                <form action="<?php echo base_url();?>admin/manage_view_emails"  method="post" id="usersearch" >
                                    <select id="customer" name="customer" onchange="manage_emails_search(this.value)">
                ...
                <div class="tablewidth">
                    <div>
                        <form method="post" action="<?php echo base_url();?>admin/changeviewemailstatus">     
                            <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
                                ...
                                <tbody>
                                    <?php     
                                    foreach($viewemails as $row)
                                    {             
                                    ?>
                                        <tr>                        
                                            <td data-title="MemberName">                        
                                                <?php echo ucfirst($row['first_name']).' '.ucfirst($row['last_name']); ?>                 
                                            </td>

                                            <td data-title="MemberEmail"><?php echo $row['email'];?></td>
                                            
                                            <td data-title="Saved_Date"><?php echo $row['sent_date'];?></td>
                                                                                        
                                            <td data-title="Actions">
                                                <a href="<?php echo base_url();?>admin/view_emails/<?php echo $row['id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;
                                                <a title="Delete" href="<?php echo base_url();?>admin/delete_view_email/<?php echo $row['id'];?>" onclick="return confirm_delete('you want to delete this email')" ><i class="icon-trash"></i></a>
                                            </td>
