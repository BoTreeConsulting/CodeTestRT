...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Guardian Property Service Commencements</title>
 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Contracts /</span> <span>Contract Commencement Checklist</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	
	
    	<div class="headtext1"><span> Contract Commencement Checklist</span></div>
...
<?php } ?>
		...
		<div class="mtext">
            	<div style=" margin-bottom:17px;">
                    <a href="<?php echo base_url();?>admin/add_contract_commencement" class="btn btn-xs btn-default btyellow pull-left">Add Commencement Checklist</a>
                    <div class="clear"></div>
                </div>
            </div>
			 <form method='post'>
    ...
    <div class="tablewidth" >
		...
		<form method="post" action="<?php echo base_url();?>commencement/change_commencement_status">
		 <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				<tbody>
				<?php foreach($commens as $row){ ?>
								<tr>
						<td data-title="Client ABN"><?php echo $row['commencement_clientabn'];?></td>
						<td data-title="Contact Person Name"><?php echo $row['commencement_contract_name'];?></td>
						<td data-title="Email Address"><?php echo $row['commencement_contract_email'];?></td>
						<td data-title="Submit On"><?php echo date("M d Y",strtotime($row['commencement_createdon']));?></td>
						<td data-title="Status"><?php echo $row['commencement_status'];?></td>
						<td data-title="Actions" ><a href="<?php echo base_url();?>admin/view_commencement/<?php echo $row['commencement_id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;<a href="<?php echo base_url();?>admin/edit_contract_commencement/<?php echo $row['commencement_id'];?>" title="Edit"><i class="icon-edit"></i></a>&nbsp;<a title="Delete" href="<?php echo base_url();?>commencement/delete_commencement/<?php echo $row['commencement_id'];?>" onclick="return confirm_delete()"><i class="icon-trash"></i></a></td>
						<td data-title="Check" ><input type="checkbox" value="<?php echo $row['commencement_id'];?>" name='id[]' ></td>
