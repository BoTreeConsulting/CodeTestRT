 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Stock Items /</span> <span>Manage Categories</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	
	
    	<div class="headtext1"><span> Manage Categories</span></div>
...
<?php } ?>
		...
		<div class="mtext">
            	<div style=" margin-bottom:17px;">
                    <a href="<?php echo base_url();?>admin/add_stockcategory" class="btn btn-xs btn-default btyellow pull-left">Add Category</a>
                    <div class="clear"></div>
                </div>
            </div>
        <div>
    <div class="tablewidth" >
        <div >
		<form method="post" action="<?php echo base_url();?>admin/change_category_status">
		   ...
		   <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				$list=$categories_list[$i];
				?>
						<tr>
						<td data-title="Category Name"><?php echo stripslashes($list->cat_title);?></td>
						<td data-title="Status"><?php echo stripslashes($list->cat_status);?></td>
						
						<td data-title="Created On"><?php echo date("Y-m-d h:i A",strtotime($list->cat_createdon)); ?></td>
						
						<td data-title="Actions" ><a href="<?php echo base_url();?>admin/view_category/<?php echo $list->cat_id;?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;<a href="<?php echo base_url();?>admin/edit_stockcategories/<?php echo $list->cat_id;?>" title="Edit"><i class="icon-edit"></i></a>&nbsp;<a title="Delete" href="<?php echo base_url();?>admin/delete_category/<?php echo $list->cat_id;?>" onclick="return confirm_delete()"><i class="icon-trash"></i></a></td>
						<td data-title="Check" ><input type="checkbox"  value="<?php echo $list->cat_id;?>" name='id[]' ></td>
