   ...
   <div class="col-lg-12 navbar-inner">
    ...
    <div class="col-md-9 rightcol">
     <?php
       ...
       $modulename = $this->uri->segment($total);?>
    	...
    	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span> <?php echo $modulename;?></span></div>
        <div class="mtextarea">
        <!--h2>Admin Panel</h2-->
        <div>
    <div class="tablewidth" >
      ...
      <td align="left">Message From</td>
        ...
        <td align="left"><a href="">View Message</a> &nbsp;<a href="">Reply Message</a></td>
      </tr>
