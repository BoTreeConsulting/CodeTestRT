...
<html lang="en">
	<head>
		...
		<script>
			...
			function submitform()
			{
				$("#properties_form").attr("action","<?php echo base_url();?>admin/managepropertylist");
			...
			$(document).ready(function()
			{
				$(".pagination li a").click(function(e)
				{
					...
					$("#properties_form").attr("action","<?php echo base_url();?>admin/managepropertylist/"+value);
	...
	<body>
		...
		<div class="col-md-12 remove-padd">
			...
			<div class="col-md-10 rtcol">
				<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Manage properties /</span><span>View Properties</span></div>
				<?php
					$total = $this->uri->total_segments();
					$modulename = $this->uri->segment($total);
				//print_r($_SESSION);?>
				<div class="headtext1"><span>Mange properties</span></div>
				...
				<div class="mtextarea mtextarea2">
					<!--h2>Admin Panel</h2-->
					<div class="mtext">
						<div style=" margin-bottom:17px;display:none;">
						...
						<div class="tablewidth" >
							<div>
								<section id="no-more-tables">
									<!--form method="post" action="<?php echo base_url();?>manageproperty/changepropertystatus"-->
									<form method="post" id="properties_form" action="<?php echo base_url();?>admin/managepropertylist">
										<div class="col-md-6 dataTables_length dataTables_wrapper no-footer" id="example_wrapper" style="margin-top: -6px; margin-left: -20px;   margin-bottom: 7px;">
											<div class="col-md-1"  style="margin-top:7px;"><b>Show </b></div>
											<div class="col-md-4">		
												<select name="limit" class="form-control" onchange="submitform()">
										...
										<div class="col-md-6" style="margin-top:-8px;">
											<div class="pull-right">
												<input type="text" id="searchproperty" name ="searchproperty" style="height:32px;" value="<?php echo $searchproperty;?>"/>
												<button  class="btn btn-primary" style="margin-top:-8px;height:32px;" onclick="submitform()"> Search </button>
											</div>
										</div>
										<br/><br/>
										<table id="example1" class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
											<thead class="cf" style=" background:#0C4371 !important;">
												<tr>
													...
													<th>Status</th>
													<th>Actions</th>
													<th style = "padding-left:10px; width:23px;display:none;" ><input type="checkbox" onchange="checkAll(this)" ></th>
											...
											<tbody>
												<?php 
													...
													<tr>
														...
														<td data-title="InquiryName"><?php  echo $row['ListingID']; ?></td>
														<td data-title="InquiryName"><?php echo $row['FullStreetAddress'];//$row['ListAgentAgentID'];?></td>
														<td data-title="InquriryContent" ><?php echo $row['ListingArea'];?></td>
														<td data-title="InquriryContent" ><?php echo $row['CityName'];?></td>
														<td data-title="InquriryContent" ><?php echo $row['State'];?></td>
														<td data-title="InquriryContent" ><?php echo $row['County'];?></td>
														
														<!--td data-title="InquriryContent" ><?php if($row['LocaleListingStatus']=='SOLD'){ echo "<span style='color:#FF0000'>SOLD</span>";?><br><p class="click agent_details" agent_id="<?php echo $row['ListAgentAgentID']; ?>" listing_id="<?php echo $row['ListingID']; ?>"><a href="">Review Request Email</a></p><?php }?></td>
														
														<td data-title="InquriryContent" ><?php if($row['LocaleListingStatus']=='SOLD'){ echo "<span style='color:#FF0000'>SOLD</span>";?><br><a href="<?php echo site_url('/admin/managereviews')?>/<?php echo $row['ListAgentAgentID']; ?>/<?php echo $row['ListingID']; ?>" target="_blank">View Reviews</a><?php }?></td-->
														...
														<td data-title="Status">
															...
															?></td>
															<td data-title="Actions" ><a href="<?php echo base_url();?>admin/view_propertydetails/<?php echo $row['Id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;<a href="<?php echo base_url();?>manageproperty/edit_property/<?php echo $row['Id'];?>" title="Edit" style="display:none;"><i class="icon-edit"></i></a>&nbsp;<a title="Delete" href="<?php echo base_url();?>manageproperty/delete_property/<?php echo $row['Id'];?>" onclick="return confirm_delete('you want to delete this property')" style="display:none;"><i class="icon-trash"></i></a></td>
															<td data-title="Check" style="display:none;"><input type="checkbox" value="<?php echo $row['Id'];?>" name='id[]' ></td>
										...
										<div >
											<!-- pagination -->
											<?php //$proplist=$this->db->query("SELECT count(*) as count1 FROM tbl_properties  ")->result();
												//$limit='10';
												$total=ceil($properties_count/$selected_limit);
											...
											$paging_info = get_paging_info($properties_count,$limit,$id); ?>
											...
											<a href='<?php echo base_url()?>admin/managepropertylist/<?php echo $id-1;?>' class='button' style='position:relative;top:-32px;left:-3px' >Prev</a>
											<?php endif; 
											...
											<ul class="pagination">
												...
												<li><a href='<?php echo base_url()?>admin/managepropertylist/1' title='Page 1'>1</a></li>
												...
												<li><a href='<?php echo base_url()?>admin/managepropertylist/<?php echo $i?>' title='Page <?php echo $i; ?>'><?php echo $i; ?></a></li>
												...
												<li><a style='background-color:#f8f8f8'>...</a></li>
												<li><a href='<?php echo base_url()?>admin/managepropertylist/<?php echo $paging_info['pages']?>' title='Page <?php echo $paging_info['pages']; ?>'><?php echo $paging_info['pages']; ?></a></li>
											...
											<a href='<?php echo base_url()?>admin/managepropertylist/<?php echo ($paging_info['curr_page'] + 1); ?>' style='position:relative;top: -32px;left: -1px;' title='Page <?php echo ($paging_info['curr_page'] + 1); ?>'>Next</a>
