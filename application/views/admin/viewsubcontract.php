 ...
 $('.myForm input').on('click', function() {
  ...
  <!-- TO CHECK VALUES COMING OR NOT-->
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Subcontracts  /</span><span>View Subcontract Information</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	
    	<div class="headtext1"> <a href="<?php echo base_url();?>admin/manage_contracts" style="color:#FFF">Manage Subcontracts </a>/ <span>View subcontract Information</span></div>
  ...
  <div class="form-group">
    ...
    <?php echo $data[0]['subcontract_clientabn']; ?>
	
	
	
  </div>
  <div class="form-group">
    <label for="exampleInputnoc">Name of Subcontract  : </label>
   <?php echo $data[0]['subcontract_contact_person']; ?>
	
  </div>
  <div class="form-group">
    <label for="exampleInputAddress">Address of Contact : </label>
    <?php echo $data[0]['subcontract_contactperson_addres']; ?>
  </div>
  <div class="form-group">
    <label for="exampleInputEmial">Email Address : </label>
    <?php echo $data[0]['subcontract_contactperson_email']; ?>
  </div>
  
  <div class="form-group">
    <label for="exampleInputcoc">Subcontract Operations Contact : </label>
    <?php echo $data[0]['subcontract_contactperson_phone']; ?>
  </div>
  <div class="form-group">
    <label for="exampleInputPos">Position : </label>
     <?php echo $data[0]['subcontract_contactperson_position']; ?>
  </div>
  
  <div class="form-group">
    <label for="exampleInputPhone">Phone : </label>
    <?php echo $data[0]['subcontract_phone']; ?>
  </div>
  <div class="form-group">
    <label for="exampleInputfax">Fax No. : </label>
    <?php echo $data[0]['subcontract_faxno']; ?>
  </div> 
  
  <div class="form-group">
    <label for="exampleInputann">Annual & Monthly Contarct Price(Excluding Vacanices & GST) : </label>
    <?php echo $data[0]['subcontract_price']; ?>
	</div>
  
   <div class="form-group">
    <label for="exampleInputccd">Contarct Commencement Date : </label>
	<?php $contcomme=date("M d Y",strtotime($data[0]['subcontract_commencement_date']));	?>
    <?php echo $contcomme; ?>
  </div> 
  
  <div class="form-group">
    <label for="exampleInputmar">Margin% : </label>
    <?php echo $data[0]['subcontract_margin']; ?>
  </div>

 <div class="form-group">
    <label for="exampleInputPassword1">Status : </label>
	  <?php echo $data[0]['subcontract_status']; ?>
	  </div>
 ...
 <!-- new table start here -->
  <div>
	 ...
	 <div class="form-group">
	  ...
	  <?php echo $data[0]['subcontract_fmservices']; ?>
	 ...
	 <div class="form-group">
	   ...
	   <?php echo $data[0]['subcontract_facily_mmanager']; ?></br>
	 ...
	 <div class="form-group">
	   ...
	   <?php echo $data[0]['subcontract_area_cleaned']; ?>
	   
     </div>

  <div class="form-group">
    <label for="exampleInputPassword1">Sub Contractor  :  <?php echo $data[0]['subcontract_subcontract']; ?></label>
   
  </div> 
  
  <div class="form-group">
    <label for="exampleInputPassword1">Area Manager : </label>
	<?php echo $data[0]['subcontract_areamanager']; ?>
  </div>	
   
  
  <div class="form-group">
    <label for="exampleInputPassword1">Who Sold Contract</label>
	<?php echo $data[0]['subcontract_who_sold']; ?>
    
  </div> 
  
   <div class="form-group">
   
	<label for="exampleInputAddress"> Comments-(Special Conditions eg. Shampoo Carpets, etc…Included in Contract) : <?php echo $data[0]['subcontract_comments']; ?></label> 
      	</div> 
	 ...
	 <?php echo $data[0]['subcontract_letter_sent']; ?>
        
     </div>
	 
 <div class="form-group">
    <label for="exampleInputPassword1">Date : </label>
	<?php $date=date("M d Y",strtotime($data[0]['subcontract_sent_date']));	?>
    <?php echo $date; ?>
  </div> 
  
  <div class="form-group">
    <label for="exampleInputPassword1">Signed by GGM : </label>
	<?php echo $data[0]['subcontract_signedby']; ?>
...
<?php
  ...
  <div class="form-group">
  <?php $createdon=date("M d Y",strtotime($data[0]['subcontract_createdon']));	?>
  ...
  <div class="form-group">
  <?php $modifiedon=date("M d Y",strtotime($data[0]['subcontract_modifiedon']));	?>
