 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span><a href="<?php echo base_url();?>admin/dashboard">Dashboard</a> /</span><span>Manage History</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	<div class="headtext1"> <span>Manage History</span></div>
    ...
    <div class="tablewidth" >
        <div >
                           <section id="no-more-tables">
							...
							<form method="post" action="<?php echo base_url();?>admin/delco">
			  ...
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				$id=$row['user_id'];
				$q=mysql_query("select admin_name from tbl_admin where admin_id='$id'");
				$new=mysql_fetch_array($q);
				?>
                                    <tr>
                                        <td data-title="Name"><?php echo ucfirst($new['admin_name']);?></td>
                                        <td data-title="Email"><?php echo $row['latitude'];?></td>
										  <td data-title="Contact person"><?php echo $row['longitude'];?></td>
                                        <td data-title="Phone Number"><?php echo date("M-d-Y h:i A",strtotime($row['cdate']));?></td>
																													
										<td><a href="#"  onclick="getmap(<?php echo $row['latitude'];?>,<?php echo $row['longitude'];?>);">view map</a></td>
										
																			
									  <td data-title="Contact person"><?php if($row['login_status'] == 1){ echo "Logged in";}else{ echo "Logout";}?></td>
										<td data-title="Action"><a title="Delete" onclick="return confirm_delete()" href="<?php echo base_url();?>admin/delete_co/<?php echo $row['l_id'];?>"><i class="icon-trash"></i></a></td>
										<td><input type="checkbox" value="<?php echo $row['l_id'];?>" name='id[]'></td>
                                    </tr>
                                     <?php } ?>
                                </tbody>
