...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Realtytopia Manage User Inquiries</title>
 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Inquiry Manager /</span><span>Mange Inquiries</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);
	//print_r($_SESSION);?>
    	<div class="headtext1"><span>Mange Inquiries</span></div>
...
<?php $DATE_FAIL = "";} ?>
		...
		<div class="mtext">
				...
				<div class="row">
				<div class="col-md-2">
				 <a href="<?php echo base_url();?>admin/add_userinquiries" class="btn btn-xs btn-default btyellow pull-left">Add Inquiry</a>
				</div>
				<div class="col-md-8">
				...
				<div class="col-sm-3">
				<!--<label>From:</label>--><input type="text" id="datepicker1" class="form-control" name="startdate" placeholder="From Date:"> 
				</div>
				<div class="col-sm-3">
				<!--<label>To:</label>--><input type="text" id="datepicker2" class="form-control" name="enddate" placeholder="To Date:"> 
				</div>
				<div class="col-sm-3">
				<input type="submit" name="submit" id="getrecords" value="Search" class="button" onClick="return checkdatevalidate();">
				</div>
				...
				<div class="col-md-2">
				<a href="<?php echo base_url();?>admin/export_excel/<?php echo $this->uri->segment(3);?>/<?php echo $this->uri->segment(4);?>">
				<img src="<?php echo base_url();?>assets/img/export-excel-icon.png">
				</a>
				</div>
				</div>
                    <div class="clear"></div>
    ...
    <div class="tablewidth" >
		...
		<form method="post" action="<?php echo base_url();?>admin/changeuserinquirystatus">
		  ...
		  <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				foreach($userinquiries as $row){
				
				?>
						<tr>
						
						<td data-title="InquiryName"><?php
         $id = $row['user_id'];
		 $uid = $this->adminmodel->getusrid($id);
		 echo $uid[0]['usrname'];
		?></td>
						<td data-title="InquiryName"><?php echo $row['inquiry_subject'];?></td>
						...
						<td data-title="Actions" ><a href="<?php echo base_url();?>admin/view_userinquiries/<?php echo $row['id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;<a href="<?php echo base_url();?>admin/edit_userinquiries/<?php echo $row['id'];?>" title="Edit"><i class="icon-edit"></i></a>&nbsp;<a title="Delete" href="<?php echo base_url();?>admin/delete_userinquiry/<?php echo $row['id'];?>" onclick="return confirm_delete('you want to delete this inquiry')" ><i class="icon-trash"></i></a></td>
 ...
 <script type="text/javascript">
  ...
  function checkdatevalidate()
  {
	  ...
	  var stdt = document.getElementById('datepicker1').value;

	  var etdt = document.getElementById('datepicker2').value;
	  ...
	  else
	  {
			...
			var stdt = Date.parse(stdt);
			var etdt = Date.parse(etdt);
			var url = "<?php echo base_url()."admin/manage_userinquiries";?>/"+stdt+"/"+etdt;
			// document.location.href = '/'+stdt+'/'+etdt;
