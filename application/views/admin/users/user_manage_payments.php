    ...
    <div class="col-md-9 rightcol">
     <?php
       ...
       $modulename = $this->uri->segment($total);?>
    	...
    	<div class="headtext1"> Users Management / <span><a style="color:#FFF" href="<?=site_url('/admin/users_management')?>">Manage Users</a></span> / <span><a style="color:#FFF" href="<?=site_url('/user/user_manage_Payments/'.$modulename)?>">Payments Done</a></span></div>
        <div class="mtextarea">
        <!--h3>Payments Done</h3-->
        <div>
    <div class="tablewidth" >
   		<a href="<?=site_url('/admin/users_management')?>" class="gobacktousers">Go Back To Manage Users</a>
    	<?php echo $output; ?>
    </div>
</div> 
