  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
    ...
    <div class="col-md-9 rightcol">
    	<div class="headtext1">User Management / Manage Listing / <span>User Profile </span></div>
        <div class="mtextarea">
         <h3>User Profile</h3><a href="<?=site_url('/admin/users_management')?>" class="">Go Back To Listing</a>
         <div class="container">
    <div>
