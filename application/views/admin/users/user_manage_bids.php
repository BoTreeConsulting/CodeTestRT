    ...
    <div class="col-md-9 rightcol">
     <?php
       ...
       $modulename = $this->uri->segment($total);?>
    	...
    	<div class="headtext1"> Users Management / <span><a style="color:#FFF" href="<?=site_url('/admin/users_management')?>">Manage Users</a></span> / <span><a style="color:#FFF" href="<?=site_url('/user/user_manage_bids/'.$modulename)?>">Manage Offers</a></span></div>
        <div class="mtextarea">
        <!--h3>Manage Offers</h3-->
        <div>
