...
<html lang="en">
	<head>
	    <meta charset="utf-8">
	    <title>Realtytopia View Saved Homes</title>
	   ...
	   <!--?php  echo"<pre>";print_r($data);echo"</pre>"; ?>
	    ...
	    <div class="col-md-12 remove-padd">
		    ...
		    <div class="col-md-10 rtcol">
				...
				<div class="headtext1"> <a href="<?php echo base_url();?>admin/manage_saved_homes" style="color:#FFF">View Saved Homes</a> / <span>View Home</span></div>
				...
				<div class="mtextarea mtextarea2">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group">
								<label for="exampleInputEmail1">Listing Id</label> :  <?php echo $viewhomes[0]['listing_id'];?>   
							</div>

							<div class="form-group">
								<label for="exampleInputEmail1">Property View</label> :  
								<a href="<?php echo base_url();?>home/property_details/<?php echo $viewhomes[0]['listing_id']; ?>" target="_blank">View Details</a>   
							</div>
							...
							<div class="form-group">
								...
								<?php
								if($viewhomes[0]['is_active']=='1')
								{
									echo "Active";
								}
								else if($viewhomes[0]['is_active']=='0')
								{
									echo "InActive";
								}
								?>
