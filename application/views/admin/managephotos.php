...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Realtytopia Manage Photos</title>
 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Manage Properties /</span><span>Manage Photos</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);
	//print_r($_SESSION);?>
    	<div class="headtext1"><span> Manage Photos</span></div>
...
<?php } ?>
		...
		<div class="mtext">
                <!--<div style=" margin-bottom:17px;">
                    <a href="<?php echo base_url();?>admin/add_franchise" class="btn btn-xs btn-default btyellow pull-left">Add Photos</a>
                    <div class="clear"></div>
                </div>-->
            </div>
        <div>
		...
		<form method="post" action="<?php echo base_url();?>admin/changefranchisestatus">
		  ...
		  <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				foreach($managephotosvalues as $row){
				
				?>
						<tr>
						
				<td data-title="AgentFirstName"><?php echo $row['propertyid'];?></td>
						...
						<td data-title="photos" >
						  ...
						  <a href="<?php echo base_url();?>admin/view_photos/<?php echo $row['propertyid'];?>">View Photos</a>
						
						</td>
						
						<!--<td data-title="Actions" ><a href="<?php echo base_url();?>admin/view_franchise/<?php echo $row['id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;<a href="<?php echo base_url();?>admin/edit_franchise/<?php echo $row['id'];?>" title="Edit"><i class="icon-edit"></i></a>&nbsp;<a title="Delete" href="<?php echo base_url();?>admin/delete_franchise/<?php echo $row['id'];?>" onclick="return confirm_delete('you want to delete this franchise')" ><i class="icon-trash"></i></a></td>
