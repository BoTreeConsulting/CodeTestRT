    ...
    <div class="col-md-9 rightcol">
     <?php
      ...
      $modulename = $this->uri->segment($total);?>
    	...
    	<div class="headtext1"> Manage Listings / <span><a style="color:#FFF" href="<?=site_url('/admin/manage_items')?>">Manage Listings</a></span> / <span><a style="color:#FFF" href="<?=site_url('/admin/bids_posted_for_the_item/'.$modulename)?>">Manage Offers</a></span></div>
        <div class="mtextarea">
        <!--h3>Offers</h3-->
        <div>
