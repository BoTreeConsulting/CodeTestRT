...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Realtytopia View Showing Requests</title>
 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"> <a href="<?php echo base_url();?>admin/manage_showing_requests" style="color:#FFF">Manage Showing Requests</a> / <span>View Showing Requests</span></div>
	...
	<?php 
				echo ucwords($viewshowingrequests[0]['user_name']);	
						?>
  ...
  <div class="form-group">
	...
	$agent_id = $viewshowingrequests[0]['agent_id'];
  ...
  <div class="form-group">
	...
	<a href="<?php echo base_url();?>home_details/index/<?php echo $viewshowingrequests[0]['property_id']; ?>-<?php echo $viewshowingrequests[0]['pId']; ?>" target="_blank">View Details</a>
