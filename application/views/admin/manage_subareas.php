 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Subareas /</span> <span>Manage Subareas</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	
	
    	<div class="headtext1"><span> Manage Subareas</span></div>
...
<button type="button" class="close" data-dismiss="alert" style="padding-right:15px;">×</button>
<strong>Error!</strong> Failed to create Subareas..
</div>
-->
<!-- 
...
<strong>Oh snap!</strong> Change a few things up and try submitting again.
		...
		<div class="mtext">
            	<div style=" margin-bottom:17px;">
                    <a href="<?php echo base_url();?>admin/add_subareas" class="btn btn-xs btn-default btyellow pull-left">Add Subarea</a>
                    <div class="clear"></div>
                </div>
				<form method='post'>
    ...
    <div class="tablewidth" >
		...
		<form method="post" action="<?php echo base_url();?>areas/change_subarea_status">
		    <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
			  <thead class="cf" style=" background:#0C4371 !important;">
				 <tr>
					  ...
					  <th>Created By</th>
					  <th>Actions</th>
					  <th  style = "padding-left:6px; width:18px;" > <input type="checkbox" onchange="checkAll(this)" ></th>
					
				  </tr>
			  </thead>
				<tbody>
				<?php foreach($subareas as $row){ 
				$crd=$row['area_createdby'];
					  $query=mysql_query("select admin_name from tbl_admin where admin_id='$crd'");
					  $data=mysql_fetch_array($query);
				?>
						<tr>
						<td data-title="Subarea Name"><?php echo $row['area_title'];?></td>
						<td data-title="Area Name"><?php echo $row['title'];?></td>
						<td data-title="Status"><?php echo $row['area_status'];?></td>
						
						<td data-title="Created On"><?php echo date("Y-m-d h:i A",strtotime($row['area_createdon'])); ?></td>
							<td data-title="Created By"><?php echo $data['admin_name']; ?></td>
						<td data-title="Actions" ><a href="<?php echo base_url();?>admin/view_subareas/<?php echo $row['area_id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;<a href="<?php echo base_url();?>admin/edit_subareas/<?php echo $row['area_id'];?>" title="Edit"><i class="icon-edit"></i></a>&nbsp;<a title="Delete" href="<?php echo base_url();?>areas/delete_subareas/<?php echo $row['area_id'];?>" onclick="return confirm_delete()"><i class="icon-trash"></i></a></td>
						<td data-title="Check" ><input type="checkbox" value="<?php echo $row['area_id'];?>" name='id[]' ></td>
