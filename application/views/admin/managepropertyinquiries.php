...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Realtytopia Manage Property Inquiries</title>
 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Inquiry Manager / </span><span>Manage Property Inquiries</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);
	//print_r($_SESSION);?>
    	<div class="headtext1"><span>Manage Property Inquiries</span></div>
...
<?php } ?>
    ...
    <div class="tablewidth" >
		...
		<form method="post" action="<?php echo base_url();?>admin/changepropertyinquirystatus">
		  ...
		  <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				foreach($agentsinquiries as $row){
				
				?>
						<tr>

                         <td data-title="EnquiryID" style="display:none;">
						...
						<td data-title="AgentFirstName">
						
						<?php
                        
							echo ucwords($row['user_fname']);
						...
						<td data-title="AgentLastName">
						
						<?php
                        
							echo ucwords($row['user_lname']);
					...
					<td data-title="AgentLastName"><a href="<?php echo base_url();?>home_details/index/<?php echo $row['property_id']; ?>-<?php echo $row['pId'];?>" target="_blank">View Details</a></td>
	...
	<?php echo date('Y-m-d', strtotime($row['created_on']));?>
						...
						<td data-title="Status" style="display:none;" >
						...
						<a href="<?php echo base_url();?>admin/view_property_inquiries/<?php echo $row['id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;
						
						<!--<a href="<?php echo base_url();?>admin/edit_agent/<?php echo $row['id'];?>" title="Edit"><i class="icon-edit"></i></a>&nbsp;
						-->
						<a title="Delete" href="<?php echo base_url();?>admin/delete_property_inquiries/<?php echo $row['id'];?>" onclick="return confirm_delete('you want to delete this property inquiry')" ><i class="icon-trash"></i></a></td>
		 ...
		 <div align="right" style="margin-top:20px;" >
							...
							<button style="display:none;" type="submit" name="status" value="Active" class="btn btn-xs btn-default btyellow pull" onclick="return validateForm()" >Active</button>
							
							<button style="display:none;" type="submit" name="status" value="Deactive" class="btn btn-xs btn-default btyellow pull" onclick="return validateForm()" >Inactive</button>
