		...
		<div id='cssmenu'>
			...
			<ul id="ollist">
				...
				<?php 
					...
					{ ?>
					<li class='has-sub <?php if($page=='manage_customers' || $page=='add_customer' || $page=='edit_customer' || $page == 'view_customer' || $page=='manage_saved_searches' || $page=='manage_saved_homes' || $page=='manage_view_emails' || $page=='view_saved_searches' || $page=='view_saved_homes' || $page=='view_emails' ){ echo "open";}?>'><a href='#'><span>Manage Members</span></a>
						
						<ul <?php if($page=='manage_customers' || $page=='add_customer' || $page=='edit_customer'|| $page == 'view_customer' || $page == 'manage_saved_searches' || $page=='manage_saved_homes' || $page=='view_saved_searches' || $page=='view_saved_homes' || $page=='manage_view_emails' || $page=='view_emails'){echo 'style="display: block"';}?>>
							...
							<li><a href="<?php echo site_url('/admin/manage_view_emails')?>" <?php if($page=='manage_view_emails' || $page=='view_emails'){echo 'style="color: #00335d;font-weight:bold;"';}?>><span>View Emails</span></a></li>
				...
				<?php $agent11 = $this->adminmodel1->get_personal_dashboard(33,$staffid);
					...
					<li class='has-sub <?php if($page=='manage_agents' || $page=='add_agent' || $page=='edit_agent' || $page == 'view_agent' || $page == 'viewagentproperties'){ echo "open";}?>'>
						<a href='#'><span>Manage Agents</span></a>
						
						<ul <?php if($page=='manage_agents' || $page=='add_agent' || $page=='edit_agent' || $page == 'view_agent' || $page == 'viewagentproperties'){ echo 'style="display: block"';}?>>
							
							
							<li><a href="<?php echo site_url('/manageagents/manage_agents')?>" <?php if($page=='manage_agents' || $page=='view_agent' || $page=='edit_agent' || $page == 'viewagentproperties'){ echo 'style="color: #00335d;font-weight:bold;"';}?>><span>Manage Agents</span></a></li>
				...
				<?php $agent11 = $this->adminmodel1->get_personal_dashboard(33,$staffid);
                    ...
                    <li class='has-sub <?php if($page == 'viewsoldpropertys' || $page=='managepropertylist' || $page=='manage_photos' ||  $page=='view_propertydetails' || $page=='managepropertylist'){ echo "open";}?>'>
                        <a href='#'><span>Manage Properties</span></a>
                        <ul <?php if($page == 'viewsoldpropertys' || $page=='managepropertylist' || $page=='manage_photos' || $page=='view_propertydetails' || $page=='managepropertylist'){ echo 'style="display: block"';}?>>
                            ...
                            <li style="display:none;"><a href="<?php echo site_url('/admin/manage_photos')?>" <?php if($page=='manage_photos'){ echo 'style="color: #00335d;font-weight:bold;"';}?>><span>Manage Photos</span></a></li>
						</ul>
					</li>
				...
				<!--Manage Properties close-->
               	...
               	<!--Manage Inquiries Open -->
				<?php 
					$d11 = $this->adminmodel1->get_personal_dashboard(30,$staffid);
					$add = $d11[0]['per_add'];
					$edit = $d11[0]['per_edit'];
					...
					if($add == 1 || $edit == 1 || $delete == 1 || $view ==1 || $assign == 1)
					{ ?>  
					<li class='has-sub <?php if($page=='manage_contact' || $page=='view_contact' || $page=='manage_request_consultation' || $page=='view_request_consultation' || $page=='manage_franchise' || $page=='view_franchise' || $page=='manage_showing_requests' || $page=='view_showing_requests' || $page=='manage_property_inquiries' || $page=='view_property_inquiries' || $page=='manage_agents_inquiries' || $page=='view_agents_inquiries'){ echo "open";}?>'><a href='#'><span>Inquiry Manager </span></a>
						<ul <?php if($page=='manage_contact' || $page=='view_contact' || $page=='manage_request_consultation' || $page=='view_request_consultation' || $page=='manage_franchise' || $page=='view_franchise' || $page=='manage_showing_requests' || $page=='view_showing_requests' || $page=='manage_property_inquiries' || $page=='view_property_inquiries' || $page=='manage_agents_inquiries' || $page=='view_agents_inquiries' || $page=='manage_home_val_inquiries' || $page=='view_home_val_inquiries' ){ echo 'style="display: block"';}?>>
							
							
							<li><a href="<?php echo site_url('/admin/manage_contact')?>" <?php if($page=='manage_contact' || $page=='view_contact'){ echo 'style="color: #00335d;font-weight:bold;"';}?>><span>Manage Contact</span></a></li>
							
							
							<li><a href="<?php echo site_url('/admin/manage_request_consultation')?>" <?php if($page=='manage_request_consultation' || $page=='view_request_consultation'){ echo 'style="color: #00335d;font-weight:bold;"';}?>><span>Manage Request Consultation</span></a></li>
							
							<?php
								$newfranch = $this->adminmodel1->get_personal_dashboard(37,$staffid);
								...
								{ 
								?>
								<li><a href="<?php echo site_url('/admin/manage_franchise')?>" <?php if($page=='manage_franchise' || $page=='view_franchise'){ echo 'style="color: #00335d;font-weight:bold;"';}?>><span>Manage Franchise</span></a></li>
							...
							<li><a href="<?php echo site_url('/admin/manage_property_inquiries')?>" <?php if($page=='manage_property_inquiries' || $page=='view_property_inquiries'){ echo 'style="color: #00335d;font-weight:bold;"';}?>><span>Manage Property Inquiries</span></a></li>
							
							
							<li><a href="<?php echo site_url('/admin/manage_agents_inquiries')?>" <?php if($page=='manage_agents_inquiries' || $page=='view_agents_inquiries'){ echo 'style="color: #00335d;font-weight:bold;"';}?>><span>Manage Agent Inquiries</span></a></li>
							
							
							<li>
								<a href="<?php echo site_url('/admin/manage_home_val_inquiries')?>" <?php if($page=='manage_home_val_inquiries' || $page=='view_home_val_inquiries'){ echo 'style="color: #00335d;font-weight:500;"';}?> >
									<span>Manage Home Value Inquiries</span>
								</a>
							</li>						
				...
				<?php $n11 = $this->adminmodel1->get_personal_dashboard(21,$staffid);
					...
					if($add == 1 || $edit == 1 || $delete == 1 || $view ==1 || $assign == 1)
					{ ?>
					<li class='has-sub <?php if($page=='cmspage' || $page=='cmspageadd' || $page=='edit_content' || $page=='cms_subpageadd' || $page=='edit_subcontent' || $page=='automailslist' || $page=='add_menu' || $page=='manage_menus' || $page=='edit_menu' || $page=='view_menu'){ echo "open";}?>'><a href='#'><span>Manage CMS</span></a>
						
						<ul <?php if($page=='cmspage' || $page=='cmspageadd' || $page=='edit_content' || $page=='cms_subpageadd' || $page=='edit_subcontent' || $page=='add_menu' || $page=='manage_menus' || $page=='edit_menu' || $page=='view_menu' || $page=='automailslist' || $page=='edit_automailcontent' || $page=='manage_helptext' || $page=='add_helptext'|| $page=='edit_helptext'){  echo 'style="display: block"';}?>>
							
							
							<li><a href="<?php echo site_url('/cms/cmspage')?>" <?php if($page=='cmspage' || $page=='cmspageadd' || $page=='edit_content' || $page=='cms_subpageadd' || $page=='edit_subcontent'){ echo 'style="color: #00335d;font-weight:bold;"'; }?>><span>Manage Pages</span></a></li>
							...
							<li style="display:none;"><a href="<?php echo site_url('/admin/manage_menus')?>" <?php if($page=='add_menu' || $page=='manage_menus' || $page=='edit_menu' || $page=='view_menu'){ echo 'style="color: #00335d;font-weight:bold;"';}?>><span>Manage Menus</span></a></li>
				...
				<?php $d11 = $this->adminmodel1->get_personal_dashboard(29,$staffid);
					...
					$view = $d11[0]['per_view'];
					$assign = $d11[0]['per_assign'];
					if($add == 1 || $edit == 1 || $delete == 1 || $view ==1 || $assign == 1 || $this->session->userdata("blog_user")=='yes' ){ ?>
				...
				<?php $ms11 = $this->adminmodel1->get_personal_dashboard(31,$staffid);
					...
					<li class='has-sub <?php if($page=='edit_outgoing_email_address' || $page=='edit_commissionrefund' || $page=='edit_homepage_saving' || $page=='edit_mortgage_interest' || $page=='edit_inquiry_email_address'){ echo "open";}?>'><a href='#'><span>Manage Settings </span></a>
						
						<ul <?php if($page=='edit_outgoing_email_address' || $page=='edit_commissionrefund' || $page=='edit_homepage_saving' || $page=='edit_mortgage_interest' || $page=='edit_inquiry_email_address'){ echo 'style="display: block"';}?>>
							...
							<li><a href="<?php echo site_url('/inquiryemailaddress/edit_inquiry_email_address')?>" <?php if($page=='edit_inquiry_email_address'){ echo 'style="color: #00335d;font-weight:bold;"';}?>><span>Inquiry Email Address</span></a></li>  
							...
							<li><a href="<?php echo site_url('/homepage_saving/edit_homepage_saving')?>" <?php if($page=='edit_homepage_saving'){ echo 'style="color: #00335d;font-weight:bold;"';}?>><span>Homepage Savings Bar</span></a></li>
							
								
							<li><a href="<?php echo site_url('/your_home_value_settings/home_value_settings')?>" <?php if($page=='home_value_settings'){ echo 'style="color: #00335d;font-weight:bold;"';}?>><span>Home Value Settings</span></a></li>
							...
							<li><a href="<?php echo site_url('/admin/edit_social_links')?>/" <?php if($page=='edit_social_links'){ echo 'style="color: #00335d;font-weight:bold;"';}?>><span>Social Links</span></a></li>  
						</ul>
					</li>
