 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner" id="path1">
	...
	<div class="headtext1" id="path2"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>CAR /</span> <span>View Corrective Action Report</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	
    	<div class="headtext1" id="path3"> <a href="<?php echo base_url();?>admin/manage_cars" style="color:#FFF">Manage Corrective Action Report </a>/ <span>View Corrective Action Report</span></div>
