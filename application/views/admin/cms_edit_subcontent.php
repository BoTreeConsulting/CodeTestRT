    ...
    <body>
        ...
        <div class="col-md-12 remove-padd">
            ...
            <div class="col-md-10 rtcol">
                ...
                <div class="headtext1"> <a href="<?php echo base_url(); ?>cms/cmspage/<?php echo $pages[0]['parent_id'];?>" style="color:#FFF">Manage CMS</a>/<span>CMS Edit Page</span></div>
                <div class="mtextarea mtextarea2">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form role="form" id="frmArticle" action="<?php echo base_url() ?>cms/updateSubArticle" method="POST"  novalidate="novalidate">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="parent_id" id="parent_id" >
                                            ...
                                            <option value='<?php echo $cmsdata[$i]['id']; ?>' <?php if($cmsdata[$i]['id'] == $pages[0]['parent_id']) { echo "selected"; } ?> ><?php echo $cmsdata[$i]['page']; ?></option>
                                            <?php } ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">			
                                    ...
                                    <input type="text" id="page" name="page" placeholder="Enter page name" class="form-control" value='<?php echo $pages[0]['page']; ?>' required>		
                                </div>		
                                <div class="form-group" style="display:none;">		
                                    <label for="block">Block Title<span class="required_field"> * </span></label>		
                                    <input type="text" id="title" name="title" placeholder="Enter block title" class="form-control" value='<?php echo $pages[0]['title']; ?>'>
                               </div>							   
							      <input type="hidden" name="id" class="form-control" value='<?php echo $pages[0]['id']; ?>'>

                                  <?php 
                                     $cms_content = html_entity_decode($pages[0]['content'], ENT_QUOTES);
                                  ?>

                                <div class="form-group">	

                                    <label for="article">Content<span class="required_field"> * </span></label>		
                                    <textarea id="article" name="article" rows="8" class="form-control" placeholder="Enter Page content">
                                    <?php echo $cms_content;?></textarea>		
                                </div>
                                ...
                                <?php 
                                $query2 = $this->db->query("select * from tbl_cms_content where id='".$pages[0]['parent_id']."'");
                                $row2= $query2->row();                                
                                ?>
