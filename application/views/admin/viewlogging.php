 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Logging /</span> <span>View Loggings</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	
    	<div class="headtext1"><a href="<?php echo base_url();?>admin/manage_commencement" style="color:#FFF"> Logging </a>/<span>View Loggings</span></div>
   ...
   <div class="form-group">
    <label for="exampleInputPassword1">Username (Full Name)</label>
    <select  class="form-control" name="username" id="username">
       <?php $staffid = $data[0]['logging_name']; ?>
	   <?php foreach($staffdata as $row){?>
       <option <?php if($staffid == $row['admin_id']){echo "selected";}?> value="<?php echo $row['admin_id'];?>" disabled><?php echo $row['admin_name'];?></option>
	   <?php } ?>
   </select>
   </div>
   
  <div class="form-group">
    <label for="exampleInputEmail1">Date and Time : </label> <?php echo $data[0]['logging_date']; ?>
    
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Event / Action : </label> <?php echo $data[0]['logging_event'] ?>
   
  </div>
  <div class="form-group" style="margin-bottom: 0px;">
    <div class="row">
              <div class="col-md-6 form-group expiration required">
                <label class="control-label">Longitude :  </label> <?php echo $data[0]['logging_longitude'] ?>
               
              </div>
              <div class="col-md-6 form-group expiration required">
                <label class="control-label">Latitude :  </label> <?php echo $data[0]['logging_latitude'] ?>
  ...
  <div class="form-group">
    <label for="exampleInputEmail1">Address : </label> <?php echo $data[0]['logging_address'] ?>
    
  </div>
  
    <div style="margin: 30px 0px; width: 100%; height: 450px;" id="us3" disabled readonly></div>
   ...
   <div class="form-group">
    <label for="exampleInputPassword1">Status : </label>  <?php echo  $status =  $data[0]['logging_status'];   ?> 
    
   </div>
   
   <?php
         $id = $data[0]['logging_created_by'];
		  $id1 = $data[0]['logging_modifiedby'];
  ...
  <div class="form-group">
       <label for="exampleInputPassword1">Created on</label> : <?php echo $data[0]['logging_createdon'];?>
  </div>
  ...
  <div class="form-group">
    <label for="exampleInputPassword1">Modified on</label> : <?php echo $data[0]['logging_modifiedon'];?>
  </div>
