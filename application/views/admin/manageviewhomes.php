...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Realtytopia Manage View Homes</title>
    ...
    <body>   
        ...
        <div class="col-md-12 remove-padd">
            ...
            <div class="col-md-10 rtcol">
                ...
                <div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Manage Members  / </span><span>View Homes</span></div>
                <?php
                   $total = $this->uri->total_segments();
                   $modulename = $this->uri->segment($total);
                ?>
                <div class="headtext1"><span> View Homes</span></div>
                ...
                <div class="tablewidth">
                    <div>
                        <form method="post" action="<?php echo base_url();?>admin/changeviewhomestatus">     
                                    ...
                                    ?>
                                        <tr>                        
                                            ...
                                            <td data-title="Actions">
                                                <a href="<?php echo base_url();?>admin/view_homes/<?php echo $row['id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;
                                                <a title="Delete" href="<?php echo base_url();?>admin/delete_view_home/<?php echo $row['id'];?>" onclick="return confirm_delete('you want to delete this home')" ><i class="icon-trash"></i></a>
                                            </td>
