 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Manage Skills assessment And Training /</span> <span>Manage Skills assessment And Training</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	
	
    	<div class="headtext1"><span> Manage Skills assessment and training</span></div>
...
//echo print_r($skills);?>
		...
		<div class="mtext">
            	<div style=" margin-bottom:17px;">
                    <a href="<?php echo base_url();?>admin/add_skills" class="btn btn-xs btn-default btyellow pull-left">Add New Skills assessment and training</a>
                    <div class="clear"></div>
                </div>
    ...
    <div class="tablewidth" >
		...
		<form method="post" action="<?php echo base_url();?>skills/change_skills_status">
		  <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				<?php foreach($skills as $row){ ?>
						<tr>
						<td data-title="Trainee’s Name"><?php echo $row['skills_trainee_name'];?></td>
						<td data-title="Trainer’s Name"><?php echo $row['skills_trainer_name'];?></td>
						<td data-title="Date"><?php echo date("M d Y",strtotime($row['skills_date']));?></td>
						<td data-title="Site"><?php echo $row['skills_site'];?></td>
						<td data-title="Submit On"><?php echo date("M d Y h:i:A",strtotime($row['skills_createdon']));?></td>					
						<td data-title="Actions" ><a href="<?php echo base_url();?>admin/view_skills/<?php echo $row['skills_id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;<a href="<?php echo base_url();?>admin/edit_skills/<?php echo $row['skills_id'];?>" title="Edit"><i class="icon-edit"></i></a>&nbsp;<a title="Delete" onclick="return confirm_delete()" href="<?php echo base_url();?>skills/delete_skills/<?php echo $row['skills_id'];?>"> <i class="icon-trash"></i></a></td>
						<td data-title="Check" ><input type="checkbox" value="<?php echo $row['skills_id'];?>" name='id[]' ></td>
