...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Realtytopia Add Page</title>
 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Manage Pages /</span> <span>Add Page</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	
    	<div class="headtext1"><a href="<?php echo base_url();?>admin/manage_pages" style="color:#FFF">Manage Pages </a>/<span>Add Page</span></div>
...
<?php } ?>
		...
		<div class="row">
		<div class="col-md-6">
		 <form role="form" method="POST" id="addpageformid" novalidate="novalidate">
		 
		 <?php $parentmenuids=$this->db->query("select * from tbl_menus where is_active=1")->result(); 
...
?>
  ...
  <div class="form-group"  >
    ...
    <input type="text" class="form-control" name="pagename" id="pagename" placeholder="Enter Page Name">
  ...
  <div class="form-group">
	...
	<br/>
    <textarea name="pagecontent" id="pagecontent" rows="10" cols="75" placeholder="Enter Page Description"></textarea>
  </div>
  ...
  <button type="submit" name="addpage" class="btn btn-xs btn-default btyellow" style="height:35px;">Add Page</button>
  </div>
</form>
		</div>
		<div class="col-md-6">
