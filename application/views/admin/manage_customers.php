...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Realtytopia Manage Members</title>
 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Manage Members /</span><span>Manage Members</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);
	//print_r($_SESSION);?>
    	<div class="headtext1"><span> Manage Members</span></div>
...
<?php } ?>
		...
		<div class="mtext">
            	<div style=" margin-bottom:17px;">
                    <a href="<?php echo base_url();?>admin/add_customer" class="btn btn-xs btn-default btyellow pull-left">Add Member</a>
                    <div class="clear"></div>
                </div>
            </div>
        <div>
    <div class="tablewidth" >
		...
		<form method="post" action="<?php echo base_url();?>customer/changestatus">
		  ...
		  <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				?>
						...
						<td data-title="Name"><?php echo $row['first_name'];?></td>
						<td data-title="LastName"><?php echo $row['last_name'];?></td>
						<td data-title="Email" ><?php echo $row['email'];?></td>
						<td data-title="Phone Number" ><?php echo $row['phone'];?></td>
						<td data-title="Status" ><?php echo $row['is_active'];?></td>
						<td data-title="Actions" ><a href="<?php echo base_url();?>customer/view_customer/<?php echo $row['id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;<a href="<?php echo base_url();?>customer/edit_customer/<?php echo $row['id'];?>" title="Edit"><i class="icon-edit"></i></a>&nbsp;<a title="Delete" href="<?php echo base_url();?>customer/delete_customer/<?php echo $row['id'];?>" onclick="return confirm_delete('you want to delete this member')" ><i class="icon-trash"></i></a></td>
