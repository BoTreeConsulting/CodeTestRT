...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Guardian Property Service Appointments</title>
 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Appointments /</span> <span>Manage Appointments</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	
	
    	<div class="headtext1"><span> Manage Appointments</span></div>
...
<button type="button" class="close" data-dismiss="alert" style="padding-right:15px;">×</button>
<strong>Error!</strong> Failed to create Appointments information..
</div>
...
<strong>Oh snap!</strong> Change a few things up and try submitting again.
		...
		<div class="mtext">
            	<div style=" margin-bottom:17px;">
                    <a href="<?php echo base_url();?>admin/add_appointment" class="btn btn-xs btn-default btyellow pull-left">Add Appointments</a>
                    <div class="clear"></div>
                </div>
            </div>
			...
			<!--search starts here-->
	       <form method='post'>
		   <b> Customer name:</b><input type="text"  name="name" style="height:30px; margin-top:10px;" value="<?php echo $searchname; ?>" >&nbsp;&nbsp;&nbsp;
		 
		   	<b>Appointment from:</b><input type="text" name="from" style="height:30px; margin-top:10px;" id="dateid" value="<?php echo $searchfrom; ?>">&nbsp;&nbsp;&nbsp;
    ...
    <div class="tablewidth" >
        <div >
			...
			<form method="post" action="<?php echo base_url();?>appoinment/delete_appointment">
		  <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				$time_in_12_hour_format  = date("g:i a", strtotime($row['ap_time']));
				$query=mysql_query("select ac_name from  tbl_customer where ac_id='$id'");
				$data=mysql_fetch_array($query);
				?>
				<tr>
						<td data-title="Customer Name"><?php echo $data['ac_name'];?></td>
						<td data-title="Appointment On"><?php echo $date;?></td>
						<td data-title="Appointment Time"><?php echo $time_in_12_hour_format;?></td>
						<td data-title="Email"><?php echo $row['ap_email'];?></td>
						<td data-title="Phone Number"><?php echo $row['ap_phone'];?></td>
						
						<td data-title="Actions"><a href="<?php echo base_url();?>admin/view_appointment/<?php echo $row['ap_id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;<a href="<?php echo base_url();?>admin/edit_appointment/<?php echo $row['ap_id'];?>" title="Edit"><i class="icon-edit"></i></a>&nbsp;<a title="Delete" href="<?php echo base_url();?>appoinment/delete_appointment/<?php echo $row['ap_id'];?>" onclick="return confirm_delete()" ><i class="icon-trash"></i></a></td>
						<td data-title="Check" ><input type="checkbox" value="<?php echo $row['ap_id'];?>" name='id[]'  ></td>
					...
					<?php 
						...
						<td data-title="Actions" ><a href="" title="View details"><i class="icon-eye-open"></i></a>&nbsp;<a href="<?php echo base_url();?>admin/edit_appointment" title="Edit"><i class="icon-edit"></i></a>&nbsp;<a title="Delete" href=""><i class="icon-trash"></i></a></td>
