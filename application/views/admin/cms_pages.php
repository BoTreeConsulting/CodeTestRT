...
function checkAll(ele) {
    ...
    <!-- Custom Fonts -->	<!--
    <link href="font-awesome-4.1.0/css/font-awesome.min.css" rel="stylesheet" type="text/css">	-->	<link href="<?php echo base_url();?>assets/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<?php } ?>
		...
		<div class="mtext">
            	<div style=" margin-bottom:17px;">
                   <h2>Pages List</h2>
				    <!--a href="<?php //echo base_url();?>cms/cmspageadd" class="btn btn-xs btn-default btyellow pull-left">Add New Page</a-->
                    <div class="clear"></div>
                </div>
            </div>
        <div>
		  ...
		  <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
			   <thead class="cf" style=" background:#0C4371 !important;">
				...
				foreach($pages as $row){
					//echo $row['id']."---".$row['page'];
				?>
					<tr>						
						<td data-title="PageName"><?php echo $row['page'];?></td>
						<td data-title="BlockTitle"><?php echo ucwords($row['link_name']);?></td>
						<td data-title="Sub Pages" class="text-center">
							<?php if($row['id']!='47' && $row['id']!='8' && $row['id']!='48' ){ ?>
								<a href="<?php echo base_url();?>cms/cmspage/<?php echo $row['id'];?>" title="Edit">View Sub Page</a>
							<?php  } else if($row['id']!='47' || $row['id']!='8' ||  $row['id']!='48'){ echo '-'; } ?>
						</td>
						<td data-title="Actions">&nbsp;<a href="<?php echo base_url();?>cms/edit_content/<?php echo $row['id'];?>" title="Edit"><i class="icon-edit"></i></a></td>
					</tr>	
					<?php 
