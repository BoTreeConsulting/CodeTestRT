...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Realtytopia Manage Contact</title>
 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span> Inquiry Manager / </span><span>Manage Contact</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);
	//print_r($_SESSION);?>
    	<div class="headtext1"><span> Manage Contact</span></div>
...
<?php } ?>
		...
		<div class="mtext" style="display:none;">
            	<div style=" margin-bottom:17px;">
                    <a href="<?php echo base_url();?>admin/add_contact" class="btn btn-xs btn-default btyellow pull-left">Add New</a>
                    <div class="clear"></div>
                </div>
            </div>
        <div>
    <div class="tablewidth" >
		...
		<form method="post" action="<?php echo base_url();?>admin/changecontactstatus">
		  ...
		  <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				?>
						...
						<td data-title="ContactId"  style="display:none;"><?php echo $row['id'];?></td>

						<td data-title="AgentFirstName"><?php echo ucwords($row['cont_firstname']);?></td>
						
						<td data-title="AgentLastName"><?php echo ucwords($row['cont_secondname']);?></td>

                        <td data-title="AgentMail"><?php echo $row['cont_email'];?></td>
						
						<td data-title="AgentPhone"><?php echo $row['cont_phone'];?></td>
						...
						<td data-title="Actions" ><a href="<?php echo base_url();?>admin/view_contact/<?php echo $row['id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;<a title="Delete" href="<?php echo base_url();?>admin/delete_contact/<?php echo $row['id'];?>" onclick="return confirm_delete('you want to delete this contact')" ><i class="icon-trash"></i></a></td>
