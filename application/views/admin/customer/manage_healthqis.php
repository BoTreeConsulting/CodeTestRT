 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Customer Panel / <span>QIS /</span> <span>Manage Health QIS</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	
	
    	<div class="headtext1"><span> Manage Health QIS</span></div>
...
<?php }?>
		...
		<div class="mtext">
            	<div style=" margin-bottom:17px;">
					...
					<form method="post" name="type" action="<?php echo base_url();?>customer/customer_qis">
		   ...
		   <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				?>
						...
						<td data-title="Actions" ><a href="<?php echo base_url();?>customer/view_healthqis/<?php echo $row['qis_id'];?>" title="View details"><i class="icon-eye-open"></i></a>
