...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Guardian Property Service QIS</title>
 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Customer Panel / <span>Manage QIS / </span>View Health QIS </div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	
    	<div class="headtext1"> <a href="<?php echo base_url();?>customer/manage_healthqis" style="color:#FFF">Manage QIS</a>/ <span>View Health QIS</span></div>
