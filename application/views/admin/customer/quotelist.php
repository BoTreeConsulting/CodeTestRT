 ...
 //print_r($_SESSION);
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Customer Panel / <span>Quotations /</span> <span>Manage Quotations</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	
	
    	<div class="headtext1"><span> Manage Quotations</span></div>
...
$i=0;
						...
						<td data-title="File Name"><a  targethref='<?php echo base_url();?>assets/uploads/accounts/quotations/<?php echo $listdata[$i]->file_name; ?>'><?php echo $listdata[$i]->display_name; ?></a></td>
						...
						<td data-title="Actions" ><a  targethref='<?php echo base_url();?>assets/uploads/accounts/quotations/<?php echo $listdata[$i]->file_name; ?>'><i class="icon-eye-open"></i></a></td>
