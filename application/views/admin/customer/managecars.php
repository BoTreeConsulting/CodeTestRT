 ...
 <?php 
  ...
  <!-- TO CHECK VALUES COMING OR NOT-->
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Customer Panel / <span>CAR /</span> <span>Manage Corrective Action Reports</span></div>
     <?php
									 ...
									 <td data-title="Location"><?php echo $row['car_location']; ?></td>
                                      ...
                                      <td data-title="Submited By"><?php echo  $createdname; ?></td>
                                       ...
                                       <td data-title="Status" ><?php echo $row['car_status']; ?></td>
										<td data-title="Actions"><a href="<?php echo base_url();?>customer/view_cars/<?php echo $row['car_id']; ?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;
