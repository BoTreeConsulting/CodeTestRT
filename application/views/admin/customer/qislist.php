 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Customer Panel / <span>QIS /</span> <span>Manage QIS</span></div>
     <?php
...
<?php }?>
		...
		<div class="mtext">
            	<div style=" margin-bottom:17px;">
					...
					<form method="post" name="type" action="<?php echo base_url();?>customer/manage_healthqis">
					<select class="form-control selectqis" name="qis" id="qis" onchange="this.form.submit()" >
					<option value="normal">Normal QIS</option>
					<option value="health" >Health QIS</option>
					</select>
					</form>
                    <div class="clear"></div>
                </div>
		   ...
		   <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				?>
						...
						<td data-title="Actions" ><a href="<?php echo base_url();?>customer/view_normalqis/<?php echo $row['qis_normal_id'];?>" title="View details"><i class="icon-eye-open"></i></a>
