...
<?php } ?>
		...
		<div class="col-md-6">
		 <form role="form" action="<?php echo base_url(); ?>admin/add_photos/<?php echo $this->uri->segment(3);?>" method="POST" id="addphotoformid" novalidate="novalidate" enctype="multipart/form-data">
  <div class="form-group"  >
	...
	<button type="submit" name="addphotoposted" class="btn btn-xs btn-default btyellow" style="height:35px;margin-top:20px;">Submit</button>
	
	<div style="margin-left:108px;margin-top: -26px;">
