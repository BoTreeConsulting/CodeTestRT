...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Realtytopia Add Blog</title>
				...
				$("#customer").validate({
					...
					rules: {
						name: {
						  required: true,
						  remote: {
							url: "<?php echo base_url()?>admin/check_blog_title",
							type: "post",
							data: {
							  name: function() {
								return $( "#name" ).val();
					...
					messages: {
						name:{
							...
							remote: "Blog Title already taken",
						} ,
	...
	<body>
		...
		<div class="col-md-12 remove-padd">
			...
			<div class="col-md-10 rtcol">
				<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Manage Blog /</span> <span>Add Blog</span></div>
				<?php
					$total = $this->uri->total_segments();
				$modulename = $this->uri->segment($total);?>
				
				<div class="headtext1"><a href="<?php echo base_url();?>admin/manage_blogs" style="color:#FFF"> Manage Blogs </a>/<span>Add Blog</span></div>
						...
						<div class="col-md-6">
							<form role="form" method="POST" id="customer" novalidate="novalidate"  enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<textarea class="form-control" name="lastname" id="lastname" rows="10" cols="75" placeholder="Enter Blog Content"></textarea>
								</div>
								<div class="form-group">
									...
									<select class="form-control" name="category_id" id="category_id" >
										...
										<?php for($i=0;$i<count($blog_categories);$i++){ ?>
											<option value='<?php echo $blog_categories[$i]->id; ?>'><?php echo str_replace('-',' ',$blog_categories[$i]->category_name); ?></option>
										<?php } ?>
									</select>
								</div>
								<!--div class="form-group">
								...
								<button type="submit" name="add" class="btn btn-xs btn-default btyellow" style="height:35px;">Add Blog</button>
							</div>
						</form>
					</div>
					<div class="col-md-6">
