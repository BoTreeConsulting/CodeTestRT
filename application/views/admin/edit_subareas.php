 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<option  >Store Areas</option>
	<option>Mixer Areas</option>
	</select>
    
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Subarea Name</label>
    <input type="text" class="form-control" id="exampleInputEmail1" value="category1">
  </div>
  <div class="form-group">
  ...
  <button type="submit" class="btn btn-xs btn-default btyellow" style="height:35px;">Edit Subareas</button>
</form></div>
		</div>
		<div class="col-md-6">
