...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Realtytopia Manage Showing Requests</title>
 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Inquiry Manager   / </span><span>Manage Showing Requests</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);
	//print_r($_SESSION);?>
    	<div class="headtext1"><span>Manage Showing Requests</span></div>
...
<?php } ?>
    ...
    <div class="tablewidth" >
		...
		<form method="post" action="<?php echo base_url();?>admin/changeshowingrequeststatus">
		  ...
		  <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				foreach($showingrequests as $row){
				
				?>
						<tr>

                        <td data-title="ShowingID" style="display:none;">
						...
						<a href="<?php echo base_url();?>admin/view_showing_requests/<?php echo $row['id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;
						
						<!--<a href="<?php echo base_url();?>admin/edit_agent/<?php echo $row['id'];?>" title="Edit"><i class="icon-edit"></i></a>&nbsp;
						-->
						<a title="Delete" href="<?php echo base_url();?>admin/delete_showing_request/<?php echo $row['id'];?>" onclick="return confirm_delete('you want to delete this showing request')" ><i class="icon-trash"></i></a></td>
