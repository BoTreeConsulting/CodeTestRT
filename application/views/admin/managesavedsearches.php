...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Realtytopia Manage Saved Searches</title>
    ...
    <body>   
        ...
        <div class="col-md-12 remove-padd">
            ...
            <div class="col-md-10 rtcol">
            	...
            	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Manage Members  / </span><span>View Saved Searches</span></div>
                <?php
            	   $total = $this->uri->total_segments();
                   $modulename = $this->uri->segment($total);
            	?>
            	<div class="headtext1"><span> View Saved Searches</span></div>
        		    ...
        		    <div class="mtext">
                    	<div style="margin-bottom:17px;">
        					...
        					<div style="float:right;">
            					<form action="<?php echo base_url();?>admin/manage_saved_searches"  method="post" id="usersearch" >
                ...
                <div class="tablewidth">
                    <div>
                    	<form method="post" action="<?php echo base_url();?>admin/changesavedsearchstatus">		
                    				...
                    				?>
                    					<tr>						
                    						...
                    						<td data-title="Actions" >
                        						<a href="<?php echo base_url();?>admin/view_saved_searches/<?php echo $row['id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;
                        						<a title="Delete" href="<?php echo base_url();?>admin/delete_saved_search/<?php echo $row['id'];?>" onclick="return confirm_delete('you want to delete this saved search')" ><i class="icon-trash"></i></a>
                                            </td>
