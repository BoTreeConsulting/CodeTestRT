  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
    ...
    <div class="col-md-9 rightcol">
    	<div class="headtext1">Manage Listing / <span><a style="color:#FFF" href="<?=site_url('/admin/manage_items')?>">Manage Listings</a></span></div>
        <div class="mtextarea">
         <h3>User Profile</h3><a href="<?=site_url('/admin/manage_items')?>" class="">Go Back To Listings</a>
         <div class="container">
    <div>
