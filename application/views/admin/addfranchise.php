	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>New Franchise Submissions /</span> <span>Add Franchise</span></div>
     <?php
       ...
       $modulename = $this->uri->segment($total);?>
    	...
    	<div class="headtext1"><a href="<?php echo base_url();?>admin/manage_franchise" style="color:#FFF">New Franchise Submissions </a>/<span>Add Franchise</span></div>
...
<?php } ?>
  ...
  <div class="form-group"  >
    ...
    <input type="text" class="form-control" name="agentfirstname" id="agentfirstname" placeholder="Enter First Name">
	<label for="name" generated="true" class=""></label>
  </div>
  
  <div class="form-group">
    <label for="exampleInputEmail1">Last Name<span class="required_field"> * </span></label>
    <input type="text" class="form-control" name="agentlastname" id="agentlastname" placeholder="Enter Last Name">
  </div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="agentbrokerlicense" id="agentbrokerlicense" placeholder="Enter broker license" onkeypress="return blockSpecialChar(event)">
  </div>
  ...
  <button type="submit" name="addagentposted" class="btn btn-xs btn-default btyellow" style="height:35px;">Add Franchise</button>
  </div>
</form>
		</div>
		<div class="col-md-6">
