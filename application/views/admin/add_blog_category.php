...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Realtytopia Add Blog Category</title>
 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Manage Blog Categories /</span> <span>Add  Category</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	
    	<div class="headtext1"><a href="<?php echo base_url();?>admin/blog_category" style="color:#FFF"> Manage Categories </a>/<span>Add Category</span></div>
...
<?php } ?>
  ...
  <button type="submit" name="addblogcategoryposted" class="btn btn-xs btn-default btyellow" style="height:35px;">Add Category</button>
  </div>
</form>
		</div>
		<div class="col-md-6">
