...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Guardian Property Service Incident Reports</title>
 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Incident Report /</span> <span>Manage Reports</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	<div class="headtext1"> <span>Manage Reports</span></div>
...
<?php } ?>
		...
		<div class="mtext">
            	<div style=" margin-bottom:17px;">
                    <a href="<?php echo base_url();?>admin/add_report" class="btn btn-xs btn-default btyellow pull-left">Add Report</a>
                    <div class="clear"></div>
                </div>
            </div>
        <div>
    <div class="tablewidth" >
         <div >
                           <section id="no-more-tables">
								...
								<form method="post" action="<?php echo base_url();?>reports/change_report_status">
			  ...
			  <thead class="cf"  style=" background:#0C4371 !important;">
				                ...
				                foreach($reports as $row){
								 $crd=$row['inr_reported_by'];
					             $query=mysql_query("select admin_name from tbl_admin where admin_id='$crd'");
					             $data=mysql_fetch_array($query);
								
				                ?>
                                    <tr>
                                        <td data-title="Incident Person Name"><?php echo $row['inr_position'];?></td>
                                        <td data-title="Reported By"><?php echo $data['admin_name']; ?></td>
                                        
                                        <td data-title="Reported On"><?php echo date("Y-m-d h:i A",strtotime($row['inr_createdon'])); ?></td>
										 <td data-title="Location"><?php echo $row['inr_location'];?></td>
										<td data-title="Status" ><?php echo $row['inr_status'];?></td>
										<td data-title="Action"><a href="<?php echo base_url();?>admin/view_reports/<?php echo $row['inr_id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;<a href="<?php echo base_url();?>admin/edit_report/<?php echo $row['inr_id'];?>" title="Edit"><i class="icon-edit"></i></a>&nbsp;<a title="Delete" href="<?php echo base_url();?>reports/delete_report/<?php echo $row['inr_id'];?>" onclick="return confirm_delete()"><i class="icon-trash"></i></a></td>
										<td data-title=""><input type="checkbox" value="<?php echo $row['inr_id'];?>" name='id[]' ></td>
                                    </tr>
									<?php } ?>
