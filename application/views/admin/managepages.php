...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Realtytopia Manage Pages</title>
 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Manage Pages </span><!--<span>Manage Pages</span>--></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);
	//print_r($_SESSION);?>
    	<div class="headtext1"><span> Manage Pages</span></div>
...
<?php } ?>
		...
		<div class="mtext">
            	<div style=" margin-bottom:17px;">
                    <a href="<?php echo base_url();?>admin/add_page" class="btn btn-xs btn-default btyellow pull-left">Add Page</a>
                    <div class="clear"></div>
                </div>
            </div>
        <div>
    <div class="tablewidth" >
		...
		<form method="post" action="<?php echo base_url();?>admin/changepagestatus">
		  ...
		  <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				?>
						...
						<td data-title="PageName"><?php echo $row['page_name'];?></td>
						...
						<td data-title="Actions" ><a href="<?php echo base_url();?>admin/view_page/<?php echo $row['id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;<a href="<?php echo base_url();?>admin/edit_page/<?php echo $row['id'];?>" title="Edit"><i class="icon-edit"></i></a>&nbsp;<a title="Delete" href="<?php echo base_url();?>admin/delete_page/<?php echo $row['id'];?>" onclick="return confirm_delete('you want to delete this page')" ><i class="icon-trash"></i></a></td>
