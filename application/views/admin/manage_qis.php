 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>QIR /</span> <span>Manage QIR</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	
	
    	<div class="headtext1"><span> Manage QIR</span></div>
...
<?php }?>
		...
		<div class="mtext">
            	<div style=" margin-bottom:17px;">
                    <a href="<?php echo base_url();?>admin/add_qis" class="btn btn-xs btn-default btyellow pull-left">Add QIR</a>
					...
					<option value="normal">Normal QIR</option>
					<option value="health" >Health QIR</option>
					</select>
					</form>
                    <div class="clear"></div>
                </div>
    ...
    <div class="tablewidth" >
		...
		<form method="post" action="<?php echo base_url();?>qis/deleteqis">
		   <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				?>
						...
						&nbsp;<a href="<?php echo base_url();?>admin/edit_qis/<?php echo $row['qis_normal_id'];?>" title="Edit"><i class="icon-edit"></i></a>
						&nbsp;<a title="Delete" href="<?php echo base_url();?>qis/delete_normqis/<?php echo $row['qis_normal_id'];?>" onclick="return confirm_delete()" ><i class="icon-trash"></i></a>
						</td>
						<td data-title="Check" ><input type="checkbox" value="<?php echo $row['qis_normal_id'];?>" name='id[]' ></td>
						</tr>
			<?php } ?>
