 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	//print_r($_SESSION);?>
    	<div class="headtext1"><span>View Request Consultation</span></div>
...
<?php } ?>
    ...
    <div class="tablewidth" >
		...
		<form method="post" action="<?php echo base_url();?>admin/changerequestconsultationstatus">
		  ...
		  <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				?>
					...
					<td data-title="AgentLastName"><?php echo $row['last_name']; ?></td>
					<td data-title="AgentLastName"><?php echo $row['email']; ?></td>
					<td data-title="AgentLastName"><?php echo $row['phone_no']; ?></td>
						...
						<a href="<?php echo base_url();?>admin/view_req_consultation/<?php echo $row['id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;
						
						<!--<a href="<?php echo base_url();?>admin/edit_agent/<?php echo $row['id'];?>" title="Edit"><i class="icon-edit"></i></a>&nbsp;
						-->
						<a title="Delete" href="<?php echo base_url();?>admin/delete_req_consultation/<?php echo $row['id'];?>" onclick="return confirm_delete('you want to delete this request consultation')" ><i class="icon-trash"></i></a></td>
