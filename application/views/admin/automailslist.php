...
<html lang="en">
  ...
  <head>
    ...
    <title>Realtytopia Manage Email Auto-Responder</title>
   ...
   <div class="col-lg-12 navbar-inner">
    ...
    <div class="col-md-12 remove-padd">
        ...
        <div class="col-md-10 rtcol">
            	...
            	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Manage Email Auto-Responder </span></div>
            	...
            	<div class="headtext1"><span> Manage Email Auto-Responder</span></div>
                ...
                <div class="mtextarea mtextarea2">
        		    <div class="mtext">
                    	...
                    	<div style=" margin-bottom:17px;display:none;">
                            ...
                            <a href="<?php echo base_url();?>admin/add_autoresponsemail" class="btn btn-xs btn-default btyellow pull-left">Add New</a>
                				...
                				<tbody>
                    				...
                    				?>
                    					...
                    					<tr>
                    						...
                    						<td  data-title="PageID" style="display:none;"><?php echo $row['id'];?></td>

                    						<td data-title="PageName"><?php echo $row['page'];?></td>

                    						<td data-title="BlockTitle" ><?php echo $row['title'];?></td>

                    						<td data-title="Actions" >
                                                <a href="<?php echo base_url();?>admin/edit_automailcontent/<?php echo $row['id'];?>" title="Edit"><i class="icon-edit"></i></a>
                                            </td>
                    					</tr>	
