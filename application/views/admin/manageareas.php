 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Subareas /</span> <span>Manage Areas</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	
	
    	<div class="headtext1"><span> Manage Areas</span></div>
...
<button type="button" class="close" data-dismiss="alert" style="padding-right:15px;">×</button>
<strong>Error!</strong> Failed to create Areas..
</div>-->
...
<strong>Oh snap!</strong> Change a few things up and try submitting again.
		...
		<div class="mtext">
            	<div style=" margin-bottom:17px;">
                    <a href="<?php echo base_url();?>admin/add_areas" class="btn btn-xs btn-default btyellow pull-left">Add Area</a>
                    <div class="clear"></div>
                </div>
				<form method='post'>
    ...
    <div class="tablewidth" >
        <div >
			...
			<form method="post" action="<?php echo base_url();?>areas/change_area_status">
			  ...
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				<tbody>
					...
					?>
						...
						<td data-title="Area Name"><?php echo $row['area_title'];?></td>
						...
						<td data-title="Actions" ><a href="<?php echo base_url();?>admin/view_area/<?php echo $row['area_id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;<a href="<?php echo base_url();?>admin/edit_areas/<?php echo $row['area_id'];?>" title="Edit"><i class="icon-edit"></i></a>&nbsp;<a title="Delete" href="<?php echo base_url();?>areas/delete_area/<?php echo $row['area_id'];?>" onclick="return confirm_delete()"><i class="icon-trash"></i></a></td>
