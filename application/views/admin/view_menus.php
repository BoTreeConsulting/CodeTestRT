...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Realtytopia View Menu</title>
 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Manage Menus /</span><span>View Menu</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	<div class="headtext1"> <a href="<?php echo base_url();?>admin/manage_menus" style="color:#FFF">Manage Menus </a>/ <span>View Menu</span></div>
  ...
  <div class="form-group">
    <label for="exampleInputEmail1">Menu Name</label> :  <?php echo $viewmenu[0]['menu_name'];?>
   
  </div>
  
   <div class="form-group">
    <label for="exampleInputEmail1">Menu Position</label> :  <?php echo $viewmenu[0]['menu_position'];?>
   ...
   <div class="form-group">
    <label for="exampleInputPassword1">Status</label> : 
	                 ...
	                 <?php
						if($viewmenu[0]['is_active']=='1')
						{
							echo "Active";
						}
						else if($viewmenu[0]['is_active']=='0')
						{
							echo "InActive";
						}
						?>
  ...
  <div class="form-group">
	...
	<?php echo date('Y-m-d', strtotime($viewmenu[0]['created_on']));?>	
