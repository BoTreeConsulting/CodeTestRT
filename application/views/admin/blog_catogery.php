...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Realtytopia Manage Blog Categories</title>
 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Manage Blog Categories /</span><span>Manage Categories</span></div>
     <?php
...
<?php } ?>
		...
		<div class="mtext">
            	<div style=" margin-bottom:17px;">
                    <a href="<?php echo base_url();?>admin/add_blog_category" class="btn btn-xs btn-default btyellow pull-left">Add Category</a>
                    <div class="clear"></div>
                </div>
            </div>
        <div>
    <div class="tablewidth" >
		...
		<form method="post" action="<?php echo base_url();?>admin/change_blogcategory_status">
		  ...
		  <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				?>
						<tr>
						<td data-title="Name"><?php echo str_replace('-',' ',$row['category_name']);?></td>
						...
						?></td>
						<td data-title="Actions" ><a href="<?php echo base_url();?>admin/view_blog_cat/<?php echo $row['id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;<a href="<?php echo base_url();?>admin/edit_blog_cat/<?php echo $row['id'];?>" title="Edit"><i class="icon-edit"></i></a>&nbsp;<a title="Delete" href="<?php echo base_url();?>admin/delete_blog_cat/<?php echo $row['id'];?>" onclick="return confirm_delete('you want to delete this blog category')" ><i class="icon-trash"></i></a></td>
