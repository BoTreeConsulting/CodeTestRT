...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Realtytopia View Agents Properties</title>
 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>View Agents Properties</span><!--<span>Manage Agents</span>--></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);
	//print_r($_SESSION);?>
    	<div class="headtext1"><span> View Agents Properties</span></div>
		  ...
		  <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				?>
						...
						<td data-title="AgentFirstName"><?php echo $row['ListingID'];?></td>
						<td data-title="AgentLastName"><?php echo $row['ListAgentAgentID'];?></td>
						<td data-title="OfficeOfficePhone"><?php echo $row['ListingArea'];?></td>
						<td data-title="AgentID"><?php echo $row['CityName'];?></td>
			            
						<td data-title="AgentKey"><?php echo $row['State'];?></td>
						<td data-title="AgentSystemLocale"><?php echo $row['County'];?></td>
