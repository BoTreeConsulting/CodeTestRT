...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Realtytopia Manage Blogs</title>
	...
	<body>
		...
		<div class="col-md-12 remove-padd">
			...
			<div class="col-md-10 rtcol">
				<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Manage Blog /</span><span>Manage Blogs</span></div>
				<?php
					$total = $this->uri->total_segments();
					$modulename = $this->uri->segment($total);
				//print_r($_SESSION);?>
				<div class="headtext1"><span> Manage Blogs</span></div>
				...
				<div class="mtextarea mtextarea2">
					...
					<div class="mtext">
						<div style=" margin-bottom:17px;">
							<a href="<?php echo base_url();?>admin/add_blog" class="btn btn-xs btn-default btyellow pull-left">Add Blog</a>
							<div class="clear"></div>
						</div>
					</div>
					<div>
						<div class="tablewidth" >
							<div>
								<section id="no-more-tables">
									<form method="post" action="<?php echo base_url();?>admin/changeblogstatus">
										...
										<table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
											...
											<tbody>
												<?php 
													...
													?>
													<tr>
														<td data-title="Name"><?php echo $row['blog_title'];?></td>
														
														<td data-title="Email" ><?php
															$id = $row['blog_posted_by'];
														...
														?></td>
														<td data-title="Actions" ><a href="<?php echo base_url();?>admin/view_blog/<?php echo $row['id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;<a href="<?php echo base_url();?>admin/edit_blog/<?php echo $row['id'];?>" title="Edit"><i class="icon-edit"></i></a>&nbsp;<a title="Delete" href="<?php echo base_url();?>admin/delete_blog/<?php echo $row['id'];?>" onclick="return confirm_delete('you want to delete this blog')" ><i class="icon-trash"></i></a></td>
