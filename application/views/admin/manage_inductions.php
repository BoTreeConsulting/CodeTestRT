 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Manage Inductions List /</span> <span>Manage Inductions List</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	
	
    	<div class="headtext1"><span> Manage Inductions List</span></div>
...
<?php } ?>
		...
		<div class="mtext">
            	<div style=" margin-bottom:17px;">
                    <a href="<?php echo base_url();?>admin/add_induction" class="btn btn-xs btn-default btyellow pull-left">Add New Inductions List</a>
                    <div class="clear"></div>
                </div>
				<form method='post'>
    ...
    <div class="tablewidth" >
        <div >
		 ...
		 <form method="post" action="<?php echo base_url();?>induction/change_induction_status">
		   <table id="example"  class="table-bordered table-striped table-condensed cf tablesorter tablesorter-blackice">
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				<tbody>
						...
						foreach($induction as $row){ ?>
                       <tr>
						<td data-title="Cleaners Name"><?php echo $row['ind_cleaners_name'];?></td>
						<td data-title="Commencement Date"><?php echo date("M d Y",strtotime($row['ind_commencement_date']));?></td>
						
						
						<td data-title="Submit On"><?php echo date("M d Y h:i:A",strtotime($row['ind_created_on']));?></td>
						<td data-title="Status"><?php echo $row['ind_status'];?></td>
						<td data-title="Actions" ><a href="<?php echo base_url();?>admin/view_induction/<?php echo $row['ind_id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;<a href="<?php echo base_url();?>admin/edit_induction/<?php echo $row['ind_id'];?>" title="Edit"><i class="icon-edit"></i></a>&nbsp;<a title="Delete" onclick="return confirm_delete()" href="<?php echo base_url();?>induction/delete_induction/<?php echo $row['ind_id'];?>"><i class="icon-trash"></i></a></td>
						<td data-title="Check" ><input type="checkbox" value="<?php echo $row['ind_id'];?>" name='id[]' ></td>
