 ...
 <?php 
  ...
  <body>
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"> <span>Manage Venues</span></div>
    ...
    <div class="tablewidth" >
        <div >
                           <section id="no-more-tables">
							...
							<form method="post" action="<?php echo base_url();?>venues/changestatus">
			  ...
			  <thead class="cf" style=" background:#0C4371 !important;">
				...
				?>
                                    <tr>
										...
										<td data-title="Action"><a href="<?php echo base_url();?>admin/view_venue/<?php echo $row['av_id'];?>" title="View details"><i class="icon-eye-open"></i></a>&nbsp;<a href="<?php echo base_url();?>admin/edit_venue/<?php echo $row['av_id'];?>" title="Edit"><i class="icon-edit"></i></a>&nbsp;<a title="Delete" onclick="return confirm_delete()" href="<?php echo base_url();?>venues/delete_venue/<?php echo $row['av_id'];?>"><i class="icon-trash"></i></a></td>
										<td><input type="checkbox" value="<?php echo $row['av_id'];?>" name='id[]'></td>
                                    </tr>
                                     <?php } ?>
                                </tbody>
								
                            </table>
							 <div align="right" style="margin-top:20px;" > <div align="right" style="margin-top:20px;" ><button type="submit" name="status" value="Active" class="btn btn-xs btn-default btyellow pull" onclick="return validateForm()" >Active</button>
							<button type="submit" name="status" value="Deactive" class="btn btn-xs btn-default btyellow pull" onclick="return validateForm()" >Deactive</button>
