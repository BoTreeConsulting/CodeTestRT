...
$( document ).ready(function() {
 ...
 $('.myForm input').on('click', function() {
  ...
  <!-- TO CHECK VALUES COMING OR NOT-->
   ...
   $ids = $data[0]['contract_id'];
	...
	// echo "select * from tbl_contract_labour where contract_id='$ids'";
	 $query = mysql_query("select * from tbl_contract_labour where contract_id='$ids' order by id asc");
   ...
   <div class="col-lg-12 navbar-inner">
	...
	<div class="headtext1"><i><img src=" <?php echo base_url("assets/site_images/lapicon.png");?>"></i><span>Location:</span> Admin Panel / <span>Contracts List /</span><span>Modify Contract Information</span></div>
     <?php
	   $total = $this->uri->total_segments();
       $modulename = $this->uri->segment($total);?>
	
    	<div class="headtext1"> <a href="<?php echo base_url();?>admin/manage_contracts" style="color:#FFF">Manage Contracts </a>/ <span>Modify Contract Information</span></div>
    ...
    <select  class="form-control" name="cname" id="cname">
       ...
       <option value="<?php echo $row['ac_id'];?>" <?php if($row['ac_id']==$data[0]['contract_customer']){ echo "selected";}?>><?php echo $row['ac_name'];?></option>
	   <?php } ?>
   </select>
   </div>
  ...
  <div class="form-group" >
	...
	<?php $date=date("m/d/Y",strtotime($data[0]['contract_submitted_date']));	?>
    <input type="text" class="form-control"  name="subdate" id="subdate"  value="<?php echo $date; ?>"/>
	
  </div>
  <div class="form-group">
    <label for="exampleInputabn">Client ABN<span class="required_field"> * </span></label>
    <input type="text"    class="form-control" name="clientabn" id="clientabn" value="<?php echo $data[0]['contract_clientabn']; ?>">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="contact" id="contract"  value="<?php echo $data[0]['contract_contact_person']; ?>">
	
  </div>
  <div class="form-group">
    <label for="exampleInputAddress">Address of Contact <span class="required_field"> * </span></label>
    <textarea class="form-control"  id="addofcont" rows='5' cols='35' name="addofcont"  ><?php echo $data[0]['contract_contactperson_addres']; ?></textarea>
  </div>
  <div class="form-group">
    <label for="exampleInputEmial">Email Address<span class="required_field"> * </span></label>
    <input type="email" class="form-control"  name="email" id="email" value="<?php echo $data[0]['contract_contactperson_email']; ?>">
  </div>
  
  <div class="form-group">
    <label for="exampleInputcoc">Contract Operations Contact<span class="required_field"> * </span></label>
    <input type="text" class="form-control" name="coc" id="coc" value="<?php echo $data[0]['contract_contactperson_phone']; ?>">
  </div>
  <div class="form-group">
    <label for="exampleInputPos">Position<span class="required_field"> * </span></label>
     <input type="text" class="form-control" name="position" id="position" value="<?php echo $data[0]['contract_contactperson_position']; ?>">
  </div>
  
  <div class="form-group">
    <label for="exampleInputPhone">Phone<span class="required_field"> * </span></label>
    <input type="text" class="form-control" name="phone" id="phone" value="<?php echo $data[0]['contract_phone']; ?>">
  </div>
  <div class="form-group">
    <label for="exampleInputfax">Fax No<span class="required_field"> * </span></label>
    <input type="text" class="form-control" name="faxno" id="faxno"  value="<?php echo $data[0]['contract_faxno']; ?>">
  </div> 
  
  <div class="form-group">
    <label for="exampleInputann">Annual & Monthly Contarct Price(Excluding Vacanices & GST)<span class="required_field"> * </span></label>
    <input type="text" class="form-control" name="annmoncont" value="<?php echo $data[0]['contract_price']; ?>" id="annmoncont"
  
   <div class="form-group">
    <label for="exampleInputccd">Contarct Commencement Date<span class="required_field"> * </span></label>
	<?php $date1=date("m/d/Y",strtotime($data[0]['contract_commencement_date']));	?>
    <input type="text" class="form-control" name='date' id="3rddate"  value="<?php echo $date1; ?>">
  </div> 
  
  <div class="form-group">
    <label for="exampleInputmar">Margin%<span class="required_field"> * </span></label>
    <input type="text" class="form-control" id="margin"  name="margin" value="<?php echo $data[0]['contract_margin']; ?>">
  </div>
 ...
 <div class="form-group">
	...
	<option value="Active" <?php if($data[0]['contract_status']=="Active"){ echo "selected";}?>>Active</option>
	<option value="Inactive"<?php if($data[0]['contract_status']=="Inactive"){ echo "selected";}?>>Inactive</option>
	</select>  
 ...
 <!-- new table start here -->
  <div>
		...
		<section id="no-more-tables" style="margin: 20px 0px;">
		  ...
		  <table class="table-bordered table-striped table-condensed cf">
			...
			<?php while($data1 = mysql_fetch_array($query)){ ?>		
					<tr>
						<td data-title="Tasks to be performed by Trainee"><?php echo ucwords($data1['guardian_labour']); ?></td>
						
						<input type="hidden" name="getid[]" value="<?php echo $data1['id']; ?>">
						 <input type="hidden" name="labour[]" value="<?php echo $data1['guardian_labour']; ?>">
						<td data-title="Skills Assessed"><input type='text' size= '50'    name='hour[]' id='hour' value='<?php echo $data1['hours']; ?>' class="ff1" onkeypress="chkNumericin();" ></td>
						
						<td data-title="Training Required" ><input type='text' name='days[]' id='days' value='<?php echo $data1['days']; ?>' class="ff1" onkeypress="chkNumericin();" ></td>
						
						<td data-title="Training Completed" ><input type='text' name='rate[]' id ="rate" value='<?php echo $data1['rate']; ?>' class="ff1" onkeypress="chkNumericin();"></td>
						
						<td data-title="Training Completed" ><input type='text' name='amount[]' id="amount" value='<?php echo $data1['amount']; ?>' class="ff1" onkeypress="chkNumericin();" ></td>
    ...
    <input type ='radio'  name='fm' value='yes' <?php if($data[0]['contract_fmservices']=="yes"){ echo "checked";}?> id='fm'/>    <label for="exampleInputys">  Yes </label> 
	
	
      <input type ='radio' name='fm' value='no' <?php if($data[0]['contract_fmservices']=="no"){ echo "checked";}?> id='fm'/>    <label for="exampleInputno">    No  </label> 
     </div>
   ...
   <input type ='radio'  name='cc' id='cc' value='yes'  <?php if($data[0]['contract_facily_mmanager']=="yes"){ echo "checked";}?>/>   <label for="exampleInputPassword1">  Yes </label>
   
     <input type ='radio' name='cc' id='cc' value='no' <?php if($data[0]['contract_facily_mmanager']=="no"){ echo "checked";}?>/>  <label for="exampleInputPassword1">    No  </label>  
     </div>
	 ...
	 <div class="form-group">
	   ...
	   <label for="exampleInputPassword1"> Is the full area to be cleaned from commencement date :<span class="required_field"> * </span> </label></br>
         <input type ='radio'  name='cd' id='cd' value='yes' <?php if($data[0]['contract_area_cleaned']=="yes"){ echo "checked";}?>/>   <label for="exampleInputPassword1">  Yes </label>
		 
		 
      <input type ='radio' name='cd' id='cd' value='no' <?php if($data[0]['contract_area_cleaned']=="no"){ echo "checked";}?>/>   <label for="exampleInputPassword1">    No  </label> 
     </div>

 <!-- <div class="form-group">
    <label for="exampleInputPassword1">Sub Contractor<span class="required_field"> * </span></label>
    <input type="text" class="form-control" id="subcont" name="subcont" value="<?php // echo $data[0]['contract_subcontract']; ?>">
  </div> -->
   ...
   <div class="form-group">
    ...
    <select  class="form-control" name="subcont" id="subcont">
	   ...
	   <?php $subconid = $data[0]['contract_subcontract']; ?>
       <option value="<?php echo $row['subcontract_id'];?>"  <?php if($row['subcontract_id'] == $subconid ){ echo "selected"; } ?>><?php echo $row['subcontract_contact_person'];?></option>
	   <?php } ?>
   </select>
   </div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="areamgr" name="areamgr" value="<?php echo $data[0]['contract_areamanager']; ?>">
  </div> 
  
  <div class="form-group">
    <label for="exampleInputPassword1">Who Sold Contract<span class="required_field"> * </span></label>
    <input type="text" class="form-control" id="whosold" name="whosold" value="<?php echo $data[0]['contract_who_sold']; ?>">
  </div> 
   ...
   <div class="form-group">
    ...
    <textarea class="form-control"  id="comments" name="comments" rows='5' cols='35' ><?php echo $data[0]['contract_comments']; ?></textarea>
	 ...
	 <label for="exampleInputAddress">  New Client Letter sent: <span class="required_field"> * </span> </label>
        <input type ='radio'  name='ls' id="ls" value='yes' <?php if($data[0]['contract_letter_sent']=="yes"){ echo "checked";}?>/>   <label for="exampleInputPassword1">  Yes </label>
		
		
     <input type ='radio' name='ls' id="ls" value='no' <?php if($data[0]['contract_letter_sent']=="no"){ echo "checked";}?> />    <label for="exampleInputPassword1">   No  </label> 
     </div>
	 
 <div class="form-group">
    <label for="exampleInputPassword1">Date<span class="required_field"> * </span></label>
	<?php $date2=date("m/d/Y",strtotime($data[0]['contract_sent_date']));	?>
    <input type="text" class="form-control" name="2nddate" id="2nddate"  value="<?php echo $date2; ?>">
  </div> 
  
  <div class="form-group">
    <label for="exampleInputPassword1">Signed by GGM<span class="required_field"> * </span></label>
    <input type="text" class="form-control" id="ggm" name="ggm"  value="<?php echo $data[0]['contract_signedby']; ?>">
  </div> 
 ...
 <div class="form-group">
    ...
    <input type="text" class="form-control" id="clientname" name="clientname" value="<?php echo $data[0]['contract_clientname']; ?>">
  </div> 
   ...
   <div class="form-group">
    ...
    <textarea class="form-control"  id="addforinvoice"  name="addforinvoice" rows='5' cols='35' ><?php echo $data[0]['contract_address_invoice']; ?></textarea>
  </div> 
	
	
  <div class="form-group">
   	<label for="exampleInputAddress">Any Special Break Up Required On The Invoice:<span class="required_field"> * </span></label>
    <textarea class="form-control"  id="anyspecialbreak" name="anyspecialbreak" rows='5' cols='35' ><?php echo $data[0]['contract_special_breakup']; ?></textarea>
  </div> 
  
  <div class="form-group">
   	<label for="exampleInputAddress">Name Of Accounts Payable Person And Phone No: <span class="required_field"> * </span></label>
    <textarea class="form-control"  id="nameofacct" name="nameofacct" rows='5' cols='35' ><?php echo $data[0]['contract_account_name']; ?></textarea>
  </div> 
  
  <div class="form-group">
   	<label for="exampleInputAddress">Any Special Payment Terms Negotiated:<span class="required_field"> * </span></label>
    <textarea class="form-control"  id="anyspectialpay" name="anyspectialpay" rows='5' cols='35' ><?php echo $data[0]['contract_special_payments']; ?></textarea>
  </div> 
  
 
	  <div class="form-group">
    
    <input type="submit" align='right' class="btn btn-xs btn-default btyellow" style="height:35px;" name='edit' value="Edit Contract"/>
  </div> 
